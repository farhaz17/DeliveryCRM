...
class CreateAgreementAmendmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agreement_amendments', function (Blueprint $table) {
            ...
            $table->bigInteger('medical_ownership'); //company =0 ,own =1
            ...
            $table->string('admin_fee_id')->nullable();
            $table->double('payroll_deduct')->nullable();
            $table->timestamps();
