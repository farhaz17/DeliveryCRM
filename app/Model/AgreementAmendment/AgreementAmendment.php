...
class AgreementAmendment extends Model  implements Auditable
{ 
    use \OwenIt\Auditing\Auditable;
    public $table = "agreement_amendments";
    ...
    public function amounts(){
        ...
        return $this->hasMany(AgreementAmendmentAmounts::class,'agreement_amendment_id');
    }
    ...
    public function step_amounts(){
        ...
        return $this->hasMany(AgreementAmendmentAssingAmounts::class,'amendmentagreement_id');
    }
    ...
    public function get_ar_balance(){
        return $this->hasOne(ArBalanceAmendmentAgreement::class,'agreement_amendment_id');
    }
