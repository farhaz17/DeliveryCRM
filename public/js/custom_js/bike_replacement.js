...
$(document).on('click', '.sugg-drop', function(){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#bike_div").show();
            $("#bike_number").html(array.bike_number);
...
var path_out = base_url+"/"+"autocomplete_bikes_need_replace_checkout";
...
$(document).on('click', '.sugg-drop_checkout', function(){
    ...
    $.ajax({
        url:  base_url+"/"+"get_passport_name_detail",
        method: 'POST',
        data:{passport_id:keyword,_token:token,type:"replace_checkout"},
        success: function (response) {
            ...
            $("#bike_number_checkout").html(array.bike_number);

            $("#platform_div_checkout").show();
            $("#platform_name_checkout").html(array.platform_name);

            $("#old_bike_div_checkout").show();
            $("#bike_old_number_checkout").html(array.old_bike);

            $("#bike_replace_primary_id").val(array.replacement_primary_id);
