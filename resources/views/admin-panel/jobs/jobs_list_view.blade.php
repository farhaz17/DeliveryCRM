...
<tr>
                                        <td>
                                            <div class="card card-job"  onclick="viewJobDetail({{$row->id}})" >
                                                <div class="card-body">
                                                ...
                                                <div class="ul-widget5__item">
                                                    <div class="ul-widget5__content">
                                                        ...
                                                        <div class="ul-widget5__section">
                                                            ...
                                                            <h4 class="ul-widget5__desc">{{$row->job_title}}</h4>
                                                            <div class="ul-widget5__info"><span>Start Date:</span>
                                                                <span class="text-dark">{{$row->start_date}}</span>
                                                                <span>Close Date:</span><span class="text-dark">{{$row->end_date}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
...
@section('js')
    ...
    <script>
        function viewJobDetail(id)
            {
                var id=id;
                location.replace("{{ url('get_full_job_detail') }}/"+id);
            }
    </script>
