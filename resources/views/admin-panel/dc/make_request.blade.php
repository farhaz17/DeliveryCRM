...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">New Request For Checkout</div>
                    <form method="post" action="{{ route('dc_request.store')  }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 form-group mb-3  " >
                                ...
                                <select class="form-control form-control-sm " name="checkout_type" id="checkout_type"  >
                            ...
                            <div class="col-md-3 expected_div_cls mb-3" style="display: none">
                                <label for="expected_date">Expected Date To Return</label>
                            ...
                            <div class="col-md-3 form-group mb-3 shuffle_div_cls " style="display: none;" >
                                <label for="">Select Shuffle type <b>(Required)</b></label>
                                <select class="form-control form-control-sm " name="shuffle_type" id="shuffle_type"  >
                                    <option value="" selected disabled >select an option</option>
...
@section('js')
    ...
    <script>
        ...
        $("#checkout_type").change(function () {
            ...
            if(selected_val=="2" || selected_val=="1" || selected_val=="10" || selected_val=="11" ){
