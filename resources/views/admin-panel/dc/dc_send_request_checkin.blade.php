...
{{--            <li class="breadcrumb-item"><a href="{{ route('dc_manager_dashboard_new',['active'=>'operations-menu-items']) }}">DC Manager Dashboard</a></li>--}}
            <li class="breadcrumb-item active" aria-current="page">Sent Request For Checkin</li>
        </ol>
    </nav>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link text-10 active" id="home-basic-tab" data-toggle="tab" href="#homeBasic" role="tab" aria-controls="homeBasic" aria-selected="true">Pending Requests ({{ $requests->count() ? $requests->count() : '0'  }})</a></li>
                    <li class="nav-item"><a class="nav-link text-10 " id="home-basic-new_taken" data-toggle="tab" href="#new_taken" role="tab" aria-controls="new_taken" aria-selected="true">Accepted Requests ({{ $accepted->count() ? $accepted->count() : '0'  }})</a></li>
                    <li class="nav-item"><a class="nav-link text-10" id="profile-basic-tab" data-toggle="tab" href="#profileBasic" role="tab" aria-controls="profileBasic" aria-selected="false">Rejected Requests ({{ $rejected->count() ? $rejected->count() : '0'  }})</a></li>
                </ul>
...
@section('js')
    ...
    <script>
        function make_table(table_name,status,plat_id) {
            ...
            $.ajax({
                url: "{{ route('get_checkin_request_render_for_dc') }}",
                method: 'GET',
