...
@section('content')
  ...
  <style>
      ...
      .amount_detail_label{
        ...
        .row_amount_cls{
            @if(!in_array(1,Auth::user()->major_department_ids))
  ...
  <form id="agreement_form"  action ="{{ route('agreement.store') }}" method="POST" enctype="multipart/form-data" >
      {!! csrf_field() !!}
  <div class="row">
      <div class="col-md-8">
          <div class="breadcrumb main_bread_crumb">
              ...
              <div class="col-md-3 form-group mb-3">
                  ...
                  <select id="passport_number" name="passport_number" name="form_type" class="form-control form-control-rounded">
                      ...
                      @foreach($pending_passports as $pas)
                          <option value="{{ $pas['passport_id'] }}"  {{ request()->query('id')==$pas['passport_id'] ? 'selected' : '' }} >{{  $pas['passport_number']  }}</option>
                      @endforeach
                    ...
                    <div class="row">
                          <div class="col-md-6 form-group "  >
                              ...
                              <select id="ref_type" name="ref_type" class="form-control form-control-rounded">
                                  <option value=""  >Select option</option>
                                  <option value="1"  >Own Company Rider</option>
                                  <option value="2" >Out side</option>
                                  <option value="3" >Walk in Candidate</option>
                              </select>
                          </div>

                          <div class="col-md-6 form-group mb-3" id="own_company_div" style="display: none;"  >
                              ...
                              <select id="rider_name" name="rider_name" class="form-control form-control-rounded">
                                  ...
                                  @foreach($riders as $rider)
                                      <option value="{{  $rider->id }}"  >{{  $rider->personal_info ?$rider->personal_info->full_name:"No Name"  }}</option>
                                  @endforeach
...
{{--          reference serprator--}}
          ...
          <div class="row current-status_div" style="display: none;">
              <div class="col-md-6 form-group mb-3"  >
              ...
              <div class="col-md-4 form-group mb-3 four_pl_div" style="display: none"  >
                  <label for="visa_requirement">4 PL Name</label>
                  <select  name="four_pl_name" id="four_pl_name" class="form-control">
                      <option value=""  >select option</option>
                      @if(!empty($four_pl))
                      @foreach($four_pl as $names)
              ...
              <div class="col-md-3 form-group mb-3 transfer_visit"  style="display: none"  >
                  ...
                  <input type="text" name="visit_entry_date" autocomplete="off" class="form-control form-control-rounded" id="visit_entry_date">

              </div>

              <div class="col-md-3 form-group mb-3 transfer_visit"  style="display: none"  >
                  <label for="visit_exit_date">Exit Date</label>
                  <input type="text" name="visit_exit_date" autocomplete="off"  class="form-control form-control-rounded" id="visit_exit_date">
...
{{--          current status serparator--}}
          ...
          <h6 class="mr-2 visa_requirement_div" style="display: none;">Visa Requirements</h6>

          <div class="row visa_requirement_div" style="display: none;">
              <div class="col-md-6 form-group "  >
          ...
          <div class="row visa_requirement_div" style="display: none;">
              <div class="col-md-4 form-group "  >
                  ...
                  <select id="working_designation" required name="working_designation"  class="form-control form-control-rounded">
                      ...
                      <option value="8" >Bike Work shop</option>
...
{{--          visa requirement separator--}}
          ...
          <div class="render_main_cls driving_license_div" style="display: none;">
                  <div class="row">
                      <div class="col-md-3">
                          <div class="card-body">
                              <div class="card-title">Driving License</div>
                                  <label class="radio radio-outline-success" id="license_want_yes" >
                                      <input type="radio" data="Yes" value="1"   name="driving_license"  class="driving_license"  id="need_license_id"  /><span>Need New License</span><span class="checkmark"></span>
                                  </label>
                                  <label class="radio radio-outline-secondary" id="already_have_label" style="display:none;">
                                      <input type="radio"  data="No" value="2" id="already_have"  name="driving_license"  class="driving_license"  id="already_license_id"  /><span>Already have</span><span class="checkmark"></span>
                                  </label>
                                    <label class="radio radio-outline-secondary" id="not_required_license_label">
                                  <input type="radio"  data="No" value="3" id="not_required_license"  name="driving_license"  class="driving_license"  id="not_required_license"  /><span>Not Required License</span><span class="checkmark"></span>
                                  </label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3 license_type_div" style="display:none;" >
                          <div class="card-body">
                              <div class="card-title">License Type</div>
                              <label class="radio radio-outline-success" id="bike_label">
                                  <input type="radio" data="Yes" value="1"  name="license_type"  id="bike" class="licens_type" checked   /><span>Bike</span><span class="checkmark"></span>
                              </label>
                      ...
                      <div class="col-md-3 car_type_div" style="display:none;"  >
                          <div class="card-body">
                              ...
                              <label class="radio radio-outline-success" id="automatic_car_label">
                                  <input type="radio" data="Yes" value="1" id="automatic_car"  name="car_type"  class="car_type"  checked  /><span>Automatic Car</span><span class="checkmark"></span>
                              </label>
          ...
          <div class="row full_type_inside only_full_time_employee hide_cls_six">
              <div class="col-md-6 ">
                  <div class="card-body">
                      <div class="card-title">E-visa Print</div>
                      <label class="radio radio-outline-success radio_inside_evisa_print">
                          <input type="radio" value="1" name="evisa_print"   id="inside_evisa_print"  /><span>Inside E-visa Print</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success radio_outside_evisa_print">
                          <input type="radio" value="2" name="evisa_print"   id="inside_evisa_outside"  checked /><span>Outside E-visa Print</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>

              <div class="col-md-6 inside_visa_type_row " style="display: none;">
                  <div class="card-body">
                      <div class="card-title">&nbsp;</div>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="inside_visa_type"  checked/><span>Inside Status Change</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="inside_visa_type"    /><span>OutSide Status Change</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
...
{{--          driving license separator--}}
          ...
          <div class="row medical_div_cls hide_cls_six only_full_time_employee">
              <div class="col-md-6 form-group "  >
                  ...
                  <select id="medical_type" name="medical_type" class="form-control form-control-rounded  ">
                      ...
                      <option value="2" id="medical_company_option" >Company</option>
                  </select>
              </div>

              <div class="col-md-6 form-group medcial_category_div"  style="display: none;" >
                  <h6 class="mr-2">&nbsp;</h6>
                  ...
                  <select id="medical_category" name="medical_category" class="form-control form-control-rounded  ">
                      ...
                      @foreach($medical_categories as $medical)
                          <option value="{{ $medical->id }}" {{ ($med_counter=="0") ? 'selected': '' }}   >{{ $medical->name }}</option>
          ...
          <div class="row only_full_time_employee hide_cls_six">
              <div class="col-md-4 ">
                  <div class="card-body">
                      <div class="card-title">Emirates id</div>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="emirates_id"   id="own_of_emirates_id"  checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="emirates_id"   id="company_of_emirates_id"  /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="visa_pasting"  id="normal_visa_pasting"  checked/><span>Normal</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="visa_pasting"  id="urgent_visa_pasting"   /><span>Urgent</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="case_fine" id="own_case_fine"  checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="case_fine"  id="company_case_fine"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
          ...
          <div class="row only_hey_vip_divs hide_cls_six">
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="english_test"  id="own_english_test" checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="english_test"  id="company_english_test"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="rta_permit_training" id="own_permit_training"   checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="rta_permit_training"   id="company_permit_training"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="e_test"  id="own_e_test" checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="e_test"  id="company_e_test"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
          ...
          <div class="row only_hey_vip_divs hide_cls_six">
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="rta_medical" id="own_rta_medical"  checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="rta_medical"  id="company_rta_medical"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="cid_report" id="own_cid_report"  checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="cid_report" id="company_cid_report"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
              ...
              <div class="col-md-4 ">
                  <div class="card-body">
                      ...
                      <label class="radio radio-outline-success">
                          <input type="radio" value="1" name="rta_card_print" id="rta_own_card_report"  checked/><span>Own</span><span class="checkmark"></span>
                      </label>
                      <label class="radio radio-outline-success">
                          <input type="radio" value="2" name="rta_card_print" id="rta_company_card_report"   /><span>Company</span><span class="checkmark"></span>
                      </label>
                  </div>
              </div>
        ...
        <input type="hidden" name="admin_amount_field_primary_id" id="admin_amount_field_primary_id">
          ...
          <input type="hidden" name="admin_driving_licnes_amount_field" id="admin_amount_field">
          <input type="hidden" name="admin_driving_license_amount_field_primary_id" id="admin_amount_field_primary_id">
...
{{--      col 4 start here --}}
      <div class="col-md-4 col_4_formating">
          ...
          <div class="row passport_detail_row">
              <div class="col-md-5">
                  <img src="https://via.placeholder.com/150" id="passport_pic"  alt="image will come">
              </div>
              ...
              <div class="col-md-7">
                  <table class="table">
                      <tr >
                          ...
                          <th scope="col" id="given_name" ></th>
                      </tr>
                      <tr>
                          <td scope="col">Email</td>
                          <th scope="col" id="country_code" ></th>
                      </tr>
                      <tr>
                          <td scope="col">Phone</td>
                          <th scope="col" id="phone_number" ></th>
                      </tr>
                      <tr>
                          <td scope="col">Remain Days</td>
                          <th scope="col" id="date_expiry" ></th>
                      </tr>
          ...
          <table class="table">
              ...
              <tr class="hide_cls_six div_current_amount row_amount_cls">
                  <th scope="col">Current Status Amount</th>
                  <th scope="col" id="current_status_amount" class="amounts_all"></th>
              </tr>

              <tr class="hide_cls_six driving_license_amount_div row_amount_cls">
          ...
          <div class="row">
              ...
              <div class="col-md-5">
                  ...
                  <input type="number" name="discount_amount[]" id="discount_offer"  class="form-control " >
              </div>
              <div class="col-md-2">
          ...
          <div class="row" style="margin-top:5px; display: none;" id="get_arr_balance_div">
              <div class="col-md-4 form-control-rounded">
                  ...
                  <input type="text" readonly name="ar_agreed_amount" id="ar_agreed_amount"  class="form-control" >
              </div>
              <div class="col-md-4 form-control-rounded">
                  <label for="visit_entry_date" class="ar_fields_formate_cls" style="margin-bottom: 0px;">Cash Received</label>
                  <input type="text" readonly name="ar_cash_received_amount" id="ar_cash_received_amount"  class="form-control" >
              </div>
              <div class="col-md-4 form-control-rounded">
                  <label for="visit_entry_date" class="ar_fields_formate_cls" style="margin-bottom: 0px;">Discount</label>
                  <input type="text" readonly name="ar_discount_amount" id="ar_discount_amount"  class="form-control" >
              </div>

              <div class="col-md-4 form-control-rounded">
                  <label for="visit_entry_date" class="ar_fields_formate_cls" style="margin-bottom: 0px;">Total Deduction</label>
                  <input type="text" readonly name="ar_deduction_amount" id="ar_deduction_amount"  class="form-control" >
              </div>

              <div class="col-md-4 form-control-rounded">
                  <label for="visit_entry_date" class="ar_fields_formate_cls" style="margin-bottom: 0px;">Total Addition</label>
                  <input type="text" readonly name="ar_addition_amount" id="ar_addition_amount"  class="form-control" >
              </div>

              <div class="col-md-4 form-control-rounded">
                  <label for="visit_entry_date" class="ar_fields_formate_cls" style="margin-bottom: 0px;">Current Balance</label>
                  <input type="text" readonly name="ar_balance_amount" id="ar_balance_amount"  class="form-control" >
              </div>
          </div>
          ...
          <div class="col-md-6 mt-3 form-group">
              <!--                  <label for="visa_requirement">Dummy Id </label>-->
              <label class="checkbox checkbox-outline-danger">
                  <input type="checkbox" value="1" name="dummy_id" id="dummy_id"><span>Dummy Data</span><span class="checkmark"></span>
              </label>
          </div>
          ...
          <div class="row amount_step_section">
              ...
              <div class="col-md-12" style="margin-top: 5px; margin-bottom: 5px;">
                  ...
                  <input type="text" class="form-control" id="adjustment_amount"  name="adjustment_amount" value="">
              </div>
              ...
              <div class="col-md-6 form-group "  >
                  ...
                  <input type="number" name="payroll_deduct" id="payroll_deduct"  class="form-control step_amount_cls">
              </div>
                  ...
                  <div class="col-md-6 form-group "  >
                      <label for="visa_requirement">Amount</label>
                      <input type="number" name="step_amount[]" required class="form-control step_amount_cls">
...
@section('js')
    ...
    <script>
        ...
        $("#discount_offer").keyup(function () {
            ...
            if(entered_val!=="") {
                var now_sum = parseFloat(get_total_amount())-parseFloat(entered_val)-parseFloat(advance_amount)-parseFloat(disocunt_sum)-parseFloat(payroll)-parseFloat(adjustment_amount);
                now_sum = now_sum.toFixed(2);

                // $(".total_amount").html(now_sum);
                $("#g_total_amount").val(now_sum);
            }else{
                var now_sum = parseFloat(get_total_amount())-parseFloat(advance_amount)-parseFloat(disocunt_sum)-parseFloat(payroll)-parseFloat(adjustment_amount);
        ...
        $("#discount_offer").keydown(function () {
            ...
            var entered_val = $(this).val();
            if(entered_val!==""){
                var now_sum = parseFloat(get_total_amount())-parseFloat(entered_val)-parseFloat(disocunt_sum)-parseFloat(payroll)-parseFloat(adjustment_amount);
        ...
        $("#advance_amount").keyup(function () {
            ...
            if(entered_val!=="") {
                var now_sum = parseFloat(get_total_amount())-parseFloat(entered_val)-parseFloat(discount)-parseFloat(disocunt_sum)-parseFloat(payroll)-parseFloat(adjustment_amount);
                now_sum = now_sum.toFixed(2);

                // $(".total_amount").html(now_sum);
                $("#g_total_amount").val(now_sum);
            }else{
                var now_sum = parseFloat(get_total_amount())-parseFloat(discount)-parseFloat(disocunt_sum)-parseFloat(payroll)-parseFloat(adjustment_amount);
    ...
    <script>
        $(".append_discount_row").on("change", ".discount_amount_cls", function() {
            ...
            if(adjustment_amount !== ""){
             ...
             var gamer = parseFloat(get_total_amount())-parseFloat(sum)-parseFloat(first_discount)-parseFloat(advance_amount)-parseFloat(adjustment_amount);
        ...
        $(".append_discount_row").on("keydown", ".discount_amount_cls", function() {
            ...
            var adjustment_amount = $("#adjustment_amount").val();
            if(adjustment_amount!==""){
                adjustment_amount = $("#advance_amount").val();
            }else{
                adjustment_amount = "0";
            }


            var gamer = parseFloat(get_total_amount())-parseFloat(sum)-parseFloat(first_discount)-parseFloat(advance_amount)-parseFloat(advance_amount)-parseFloat(adjustment_amount);
            // $(".total_amount").html(gamer);
            $("#g_total_amount").val(gamer);
            $(".total_amount").show();
        });
...
{{--    generate amount part here--}}
    ...
    <script>
        ...
        // medical process end here
            ...
            var working_designation = $("#working_designation option:selected").val();

            var working_visa = $("#working_visa option:selected").val()
           ...
           //  var total_agree_amount = $("#g_total_amount").val();
           //  var ar_agreed_amount = $("#ar_agreed_amount").val();
           //  var ar_cash_received_amount = $("#ar_cash_received_amount").val();
           //  var ar_discount_amount = $("#ar_discount_amount").val();
           //  var ar_deduction_amount = $("#ar_deduction_amount").val();
           //
           // var adjust_now =  ar_balance_divide(total_agree_amount,ar_agreed_amount,ar_cash_received_amount,ar_discount_amount,ar_deduction_amount);

           // $("#adjustment_amount").val(adjust_now);

            window.setTimeout(function(){

                var remain_ab = $("#g_total_amount").val();
                var payroll_deduct = $("#payroll_deduct").val();

                if(payroll_deduct==""){
                    payroll_deduct = 0;
                }

                var now  = parseFloat(remain_ab)-parseFloat(payroll_deduct);
                $("#g_total_amount").val(now);
...
{{--     after modificaction jquery end here--}}
    ...
    <script>
        function get_ar_balance(passport){

            var token = $("input[name='_token']").val();
            $.ajax({
                url: '{{ route('get_ar_balance_agreement') }}',
                method: 'POST',
                data: {
                ...
                success: function (response) {
                    ...
                    if(array.agreed_amount!="no"){
                        $("#get_arr_balance_div").show();
                        $("#ar_agreed_amount").val(array.agreed_amount);
                        $("#ar_cash_received_amount").val(array.cash_received);
                        $("#ar_discount_amount").val(array.discount);
                        $("#ar_deduction_amount").val(array.deduction);
                        $("#ar_addition_amount").val(array.total_addition);
                        $("#ar_balance_amount").val(array.balance);
                        $("#payroll_deduct").val(array.balance)
                    }else{
                        $("#get_arr_balance_div").hide();
                        $("#ar_agreed_amount").val("");
                        $("#ar_cash_received_amount").val("");
                        $("#ar_discount_amount").val("");
                        $("#ar_deduction_amount").val("");
                        $("#ar_addition_amount").val("");
                        $("#ar_balance_amount").val("");
                        $("#payroll_deduct").val("");
                    }
        ...
        function ar_balance_divide(total_amount,agreed_amount,cash_received,discount,deduction){

                var total_ab = parseFloat(total_amount)-parseFloat(agreed_amount);

            var now_total = parseFloat(total_ab)+parseFloat(cash_received)+parseFloat(discount)+parseFloat(deduction);
    ...
    <script>
        $(document).ready(function(){
            ...
            window.setTimeout(function(){
                ...
                $('#passport_number').val(selected_pass).trigger('change');
            },1000);
        })
    </script>
