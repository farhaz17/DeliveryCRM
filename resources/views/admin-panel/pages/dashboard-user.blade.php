    ...
    <div class="row" style="display: none;">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Ticket"></i>
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Pending < 24 hours</p>
                        <p class="text-primary text-24 line-height-1 mb-2">{{$pending_tickets}}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Ticket"></i>
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Pending > 24 hours AND < 48 hour</p>
                        <p class="text-primary text-24 line-height-1 mb-2">{{$closed_tickets}}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Ticket"></i>
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Total Pending Tickets after 48 hours and 72 less than 47 hours</p>
                        <p class="text-primary text-24 line-height-1 mb-2">{{$in_process_tickets}}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                <div class="card-body text-center"><i class="i-Ticket"></i>
                    <div class="content">
                        <p class="text-muted mt-2 mb-0">Total Pending Tickets after 72 hours</p>
                        <p class="text-primary text-24 line-height-1 mb-2">{{$rejected_tickets}}</p>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($recent_tickets as $ticket)
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3" >
                            <div class="flex-grow-1">
                                <h5><a href="">#{{ $ticket->ticket_id }}</a></h5>
                                <p class="m-0 text-small text-muted">{{ $ticket->message }}.</p>
                                <p class="text-small text-danger m-0">status
                                    <span class="text-dark">{{ $array_status[$ticket->is_checked] }}</span>
                                </p>
                            </div>
                            <div>
                                <a  href="{{ route('manage_ticket.show',$ticket->id)  }}" class="btn btn-outline-primary mt-3 mb-3 m-sm-0 btn-rounded btn-sm">
                                    View
                                    details
                                </a>
                            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="card mb-4" style="height: 500px;" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <div class="card-body">
                    ...
                    @foreach($recent_messages as $ab)

                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                            <div class="flex-grow-1">
                                <h5><a href="">#{{ $ab->ticket->ticket_id }}</a></h5>
                                <p class="m-0 text-small text-muted">{{  $ab->chat_message}}.</p>
                                <p class="text-small text-danger m-0">status
                                    <span class="text-dark">{{ $array_status[$ab->ticket->is_checked] }}</span>
                                </p>
                            </div>
                            <div>
                                <a  href="{{ route('manage_ticket.show',$ab->ticket_id)  }}" class="btn btn-outline-primary mt-3 mb-3 m-sm-0 btn-rounded btn-sm">
                                    View details
                                </a>
                            </div>
                        </div>
    ...
    <script>
        ...
        if (echartElemPie) {
            ...
            echartPie2.setOption({
                color: ['#F15050', '#081b0d', '#008ffb',  '#008000','#775dd0'],
