...
@section('content')
    ...
    <h4 class="card-title mb-3">Sim Replacement</h4>
            ...
            <div class="col-md-12 mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form action ="{{ route('sim_replacement.store') }}" method="POST" id="form_checkin">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-check-inline mb-3 text-center" id="bike_div" style="display: none;" >
                                    <label class="radio-outline-success text-primary font-weight-bold ">Current Sim Number:</label>
                                    <h6 id="sim_number" class="text-dark ml-3 "></h6>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    <label for="repair_category">Select Sim</label>
                                    <select id="new_sim_id" name="new_sim_id" class="form-control  form-control" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group mb-3" style="display: none;" id="replace_reason_div">
                                    <label for="repair_category">Replacement Reason</label>
                                    <select id="repalce_reason" name="repalce_reason" class="form-control  form-control" >
                                        <option value=""  >Select option</option>
            ...
            <div class="col-md-12 mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form action ="{{ route('sim_replacement.update',1) }}" method="POST" id="form_checkin">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-check-inline mb-3 text-center" id="bike_div_checkout" style="display: none;" >
                                    <label class="radio-outline-success font-weight-bold text-primary ">Temporary Sim Number:</label>
                                ...
                                <div class="col-md-3 form-check-inline mb-3 text-center" id="old_bike_div_checkout" style="display: none;" >
                                    <label class="radio-outline-success font-weight-bold text-primary ">Permanent Sim Number:</label>
                            ...
                            <input type="hidden" name="sim_replace_primary_id" id="sim_replace_primary_id">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="checkbox checkbox-outline-primary">
                                        <input type="checkbox" id="make_permanent" name="make_permanent" value="1"><span class="font-weight-bold text-primary">Convert Temporary Sim Number TO Permanent Sim Number</span><span class="checkmark"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row" id="sure_div_text" style="display: none;">
                                <div class="col-md-12">
                                    <h4  class="text-dark ml-3  text-secondary font-weight-bold">Are you sure you want To Convert Temporary Sim Number TO Permanent Sim Number.?</h4>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        $(document).on('change','#new_sim_id',function(){
           var id = $(this).val();
           $('#checkin').val("") ;
           $.ajax({
    ...
    <script>
        var url_checkin = "{{ route('autocomplete_checkin_sim_for_replace') }}"
        var base_url = "{{ url('/') }}"
    </script>
    <script src="{{ asset('js/custom_js/sim_replacement.js') }}"></script>
    ...
    <script>
        $(".search_type_cls").change(function () {
            ...
            if(selected_v=="2"){
                $("#repalce_reason").removeAttr('required');
                $("#replace_reason_div").hide();
            }else{
                $("#repalce_reason").prop('required',true);
                $("#replace_reason_div").show();
            }
