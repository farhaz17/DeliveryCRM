    ...
    <div class="card text-left">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="myIconTab" role="tablist">
                <li class="nav-item"><a class="nav-link active cr-color" id="criticle-icon-tab" data-toggle="tab" href="#criticle" role="tab" aria-controls="criticle" aria-selected="true">Criticle</a></li>
                <li class="nav-item"><a class="nav-link bd-color" id="bad-icon-tab" data-toggle="tab" href="#bad" role="tab" aria-controls="bad" aria-selected="false">Bad</a></li>
                <li class="nav-item"><a class="nav-link gd-color" id="good-icon-tab" data-toggle="tab" href="#good" role="tab" aria-controls="bad" aria-selected="false">Good</a></li>
            </ul>
