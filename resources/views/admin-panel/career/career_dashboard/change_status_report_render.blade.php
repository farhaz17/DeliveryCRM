...
{{--                <a class="text-secondary mr-2 enter_passport" id="{{ $career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Diploma-2 font-weight-bold"></i></a>--}}
                @if($career->status_after_shortlist=="1")
                    <a class="text-secondary mr-2 enter_passport" id="{{ $career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Diploma-2 font-weight-bold"></i></a>
                    @else
                <a class="text-secondary mr-2 edit_visa_cls" id="{{ $career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Diploma-2 font-weight-bold"></i></a>
                  @endif
            @else
                <a class="text-secondary mr-2 edit_cls" id="{{ $career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Pen-5 font-weight-bold"></i></a>
            @endif
        </td>
    </tr>
@endforeach
