...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li>Career Walk in Candidate</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('save_career_from_social_media') }}" enctype="multipart/form-data" id="new_form">
                        {!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group mb-3">
                                        ...
                                        <br>
                                        <input class="form-control form-control-sm" id="phone"  style="width: 100%" name="phone" value="" type="text"  required />
                                    </div>

                                    <div class="col-md-12 form-group mb-3">
                                        <label for="repair_category">Whats App </label>
                                        <input class="form-control form-control-sm" id="whatsapp" name="whatsapp" value="" type="text"  required />
                                    </div>
                            ...
                            <div class="col-md-4 form-group mb-3" >
                                ...
                                {{--                                        <input class="form-control form-control-rounded" id="licence_issue_date" name="licence_issue_date" value="" type="text"  />--}}
                                {{--                                    </div>--}}

                                {{--                                    <div class="col-md-12 mb-3">--}}
                                {{--                                        <label for="repair_category">Licence number</label>--}}
                                {{--                                        <input class="form-control form-control-rounded" id="licence_no" name="licence_no" value="" type="text"   />--}}
                                {{--                                    </div>--}}
                                ...
                                {{--                                        <input class="form-control form-control-rounded" id="licence_expiry_date" name="licence_expiry_date" value="" type="text"   />--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                                ...
                                <div class="row">
                                    ...
                                    {{--                                        <div class="form-check-inline">--}}
                                    {{--                                            <label class="radio radio-outline-success">--}}
                                    {{--                                                <input type="radio" class="license_type_cls"  value="1" name="company_visa"><span>Yes</span><span class="checkmark"></span>--}}
                                    {{--                                            </label>--}}
                                    {{--                                        </div>--}}

                                    {{--                                        <div class="form-check-inline">--}}
                                    {{--                                            <label class="radio radio-outline-primary">--}}
                                    {{--                                                <input type="radio" class="license_type_cls"  value="2" name="company_visa"><span>No</span><span class="checkmark"></span>--}}
                                    {{--                                            </label>--}}
                                    {{--                                        </div>--}}
                                    {{--                                    </div>--}}
