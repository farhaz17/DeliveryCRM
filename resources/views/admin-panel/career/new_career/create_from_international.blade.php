...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li>Career For International</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('save_career_from_international') }}" enctype="multipart/form-data" id="new_form">
                        {!! csrf_field() !!}
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm" id="whatsapp" name="whatsapp" value="" type="number" required />
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 form-group mb-3" >
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="repair_category">Do you have Passport.? <b>(required)</b></label>
                                            <br>
                                            <div class="form-check-inline">
                                                <label class="radio radio-outline-success">
                                                    <input type="radio"    value="1" name="is_passport" ><span>Yes</span><span class="checkmark"></span>
                                                </label>
                                            </div>

                                            <div class="form-check-inline">
                                                <label class="radio radio-outline-primary">
                                                    <input type="radio"  value="2" name="is_passport"><span>No</span><span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
...
{{--                                        </select>--}}
{{--                                    </div>--}}
                                    <input type="hidden" name="source_type" value="6">
