        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('save_career_from_on_call') }}" enctype="multipart/form-data" id="new_form">
                        {!! csrf_field() !!}
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group mb-3">
                                        ...
                                        <input class="form-control form-control-sm" id="phone" name="phone" value="" type="number"  required />
                                    </div>

                                    <div class="col-md-12 form-group mb-3">
                                        <label for="repair_category">Whats App <b>(required)</b> </label>
                                        <input class="form-control form-control-sm" id="whatsapp" name="whatsapp" value="" type="number"  />
                                    </div>
