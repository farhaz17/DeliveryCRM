        ...
        <div class="card-body">
            ...
            <div class="not_verified">
                <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-top: 10px;">
                    <li class="nav-item">
                        <a class="nav-link active" id="NoActionTab" data-toggle="tab" href="#NoAction" role="tab" aria-controls="NoAction" aria-selected="true">No Action Yet ({{$career_counts}})
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="TodayTab" data-toggle="tab" href="#Today" role="tab" aria-controls="Today" aria-selected="true">Today ({{$today->count()}})
                        </a>
                    </li>
                    @foreach($followup_fronts as $follow)
                    <li class="nav-item">
                            ...
                            <table class="display table table-sm table-striped text-10 table-bordered" id="NoActionTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-primary mr-2 follow_up" data-category="1" data-today="1"  id="{{ $frontdesk->id  }}" href="javascript:void(0)"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                                            <a class="text-primary mr-2 view_cls" id="{{ $frontdesk->id  }}" href="javascript:void(0)"><i class="nav-icon i-eye font-weight-bold"></i></a>
                                            <a class="text-danger mr-2 rejection" id="{{ $frontdesk->id  }}" href="javascript:void(0)"><i class="nav-icon i-Close font-weight-bold"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <table class="display table table-sm table-striped text-10 table-bordered" id="TodayTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-primary mr-2 follow_up" data-category="1" data-today="1"  id="{{ $todays->career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            retrieve: true,
            ajax:{
                url : "{{route('ajax_frontdesk_follow_up')}}",
                data:{id: id},
            },
            columns: [
                { data: 'career_name' },
...
<script>
    $(document).ready(function () {
        'use strict';
        $('#TodayTable, #CallMeTomorrowTable, #NoResponseTable,#NotInterestedTable').DataTable( {
            initComplete: function () {
                        let filtering_columns = []
                        $(this).children('thead').children('tr').children('th.filtering_source_from').each(function(i, v){
                            filtering_columns.push(v.cellIndex+1)
