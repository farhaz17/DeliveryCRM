        ...
        <div class="card-body">
                 ...
                 <div class="selected">
                    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-top: 10px;">
                        ...
                        @foreach($followup_selecteds as $follow)
                        <li class="nav-item">
                                ...
                                <table class="display table table-sm table-striped text-10 table-bordered" id="sTodayTable" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="text-primary mr-2 follow_up" data-category="3" data-today="1" id="{{ $todays->career->id  }}" href="javascript:void(0)"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>N/A</td>
                                            <td>
                                                <a class="text-primary mr-2 rejoin_follow_up" data-category="3" data-today="1" id="{{ $todays->passport_id  }}" href="javascript:void(0)"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
         ...
         <div class="modal fade bd-example-modal-sm"  id="rejoin_reject_remarks_modal"tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle-1" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <form action="{{ route('selected_rejoin_reject_save') }}" method="POST">
                        @csrf
    ...
    <div class="modal fade bd-example-modals-lg" id="passport_detail_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modals-lg">
            ...
            @section('js')
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        retrieve: true,
                        ajax:{
                            url : "{{route('ajax_selected_follow_up')}}",
                            data:{id: id},
                        },
                        columns: [
                            { data: 'career_name' },
            ...
            <script>
                $(document).ready(function () {
                    'use strict';
                    $('#sInterstedTable, #sCallMeTomorrowTable, #sNoResponseTable,#sNotInterestedTable').DataTable( {
                        "aaSorting": [[0, 'desc']],
                        "pageLength": 10,
                        "columnDefs": [
