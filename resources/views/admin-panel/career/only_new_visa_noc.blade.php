        ...
        <div class="card text-left">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="home-basic-tab" data-toggle="tab" href="#homeBasic" role="tab" aria-controls="homeBasic" aria-selected="true">New Visa/Ready to take visa ({{ isset($new_visa) ? $new_visa->count() : '0' }})  </a></li>
                    <li class="nav-item"><a class="nav-link" id="profile-basic-tab" data-toggle="tab" href="#profileBasic" role="tab" aria-controls="profileBasic" aria-selected="false">Freelance/NOC ({{ isset($freelance_visa) ? $freelance_visa->count() : '0' }}) </a></li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="homeBasic" role="tabpanel" aria-labelledby="home-basic-tab">
                        ...
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered table-sm" id="datatable_career">
...
{{--                                        </td>--}}
                    ...
                    <div class="tab-pane fade show" id="profileBasic" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            ...
                            <table class="display table table-striped table-bordered table-sm" id="datatable_career_referals">
                                <thead class="thead-dark">
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Name</th>
...
{{--                                    <th scope="col">Action</th>--}}
                    ...
                    <div class="tab-pane fade show" id="lincenseTab" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            ...
                            <table class="display table table-striped table-bordered table-sm" id="datatable_career_license">
                                <thead class="thead-dark">
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Name</th>
                    ...
                    <div class="tab-pane fade show" id="NolincenseTab" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            ...
                            <table class="display table table-striped table-bordered table-sm" id="datatable_career_nolicense">
                                <thead class="thead-dark">
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Name</th>
...
@section('js')
        ...
        $(document).ready(function () {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                if(currentTab=="home-basic-tab"){
                    ...
                    tabs_table("new_visa","","datatable_career");
                    ...
                    tabs_table("freelance","","datatable_career_referals");
                    get_color_block_count("freelance","referal_priority_hours_24_block","referal_priority_hours_48_block","referal_priority_hours_72_block","referal_priority_less_24_block");

                }else if(currentTab=="license_tab"){

                    tabs_table("withlicense","","datatable_career_license");
                    get_color_block_count("withlicense","license_priority_hours_24_block","license_priority_hours_48_block","license_priority_hours_72_block","license_priority_less_24_block");
    ...
    <script>
        ...
        $("#first_priority_hours_24_block").click(function () {
            ...
            first_priority_filter_color("new_visa","orange");
        });

        $("#first_priority_hours_48_block").click(function () {

            first_priority_filter_color("new_visa","pink");
        });

        $("#first_priority_hours_72_block").click(function () {

            first_priority_filter_color("new_visa","red");
        });

        $("#first_priority_less_24_block").click(function () {

            first_priority_filter_color("new_visa","white");
        });

        $("#remove_apply_filter_two").click(function () {

            first_priority_filter_color("new_visa","");
            get_color_block_count("new_visa ","first_priority_hours_24_block","first_priority_hours_48_block","first_priority_hours_72_block","first_priority_less_24_block");
        });
        ...
        $("#referal_priority_hours_24_block").click(function () {
            ...
            referal_priority_filter_color("freelance","orange");
        });

        $("#referal_priority_hours_48_block").click(function () {

            referal_priority_filter_color("freelance","pink");
        });

        $("#referal_priority_hours_72_block").click(function () {

            referal_priority_filter_color("freelance","red");
        });

        $("#referal_priority_less_24_block").click(function () {

            referal_priority_filter_color("freelance","white");
        });
        $("#remove_apply_filter_referal").click(function () {

            referal_priority_filter_color("freelance","");
            get_color_block_count("freelance","referal_priority_hours_24_block","referal_priority_hours_48_block","referal_priority_hours_72_block","referal_priority_less_24_block");
        });
    ...
    <script>
        $("#license_priority_hours_24_block").click(function () {
            ...
            tabs_table("withlicense","orange","datatable_career_license");
        ...
        $("#license_priority_hours_48_block").click(function () {
            ...
            tabs_table("withlicense","pink","datatable_career_license");
        });

        $("#license_priority_hours_72_block").click(function () {


            tabs_table("withlicense","red","datatable_career_license");
        });

        $("#license_priority_less_24_block").click(function () {

            // referal_priority_filter_color("document_pending_referals","white");
            tabs_table("withlicense","white","datatable_career_license");
        });
