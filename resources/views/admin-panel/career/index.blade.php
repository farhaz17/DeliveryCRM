                ...
                <div class=" text-left">
                    <div class="">
                        ...
                        <ul class="nav nav-tabs" id="myIconTab" role="tablist">
                            <li class="nav-item"><a class="nav-link text-10 active" id="home-icon-tab" data-toggle="tab" href="#first_priority" role="tab" aria-controls="first_priority" aria-selected="true"><i class="nav-icon i-Remove-User mr-1"></i>First Priority ({{ $first_priority->count()  }})</a></li>
                            <li class="nav-item"><a class="nav-link text-10" id="profile-icon-tab" data-toggle="tab" href="#second_priority" role="tab" aria-controls="second_priority" aria-selected="false"><i class="nav-icon i-Visa mr-1"></i>Second Priority ({{ $second_priority->count()  }})</a></li>
                            <li class="nav-item"><a class="nav-link text-10" id="contact-icon-tab" data-toggle="tab" href="#third_priority" role="tab" aria-controls="third_priority" aria-selected="false"><i class="nav-icon i-Over-Time-2 mr-1"></i>Third Priority ({{ $third_priority->count()  }})</a></li>
                            <li class="nav-item"><a class="nav-link text-10" id="referal-icon-tab" data-toggle="tab" href="#referal_priority" role="tab" aria-controls="referal_priority" aria-selected="false"><i class="nav-icon i-Over-Time-2 mr-1"></i>Referals ({{ $referal_users->count()  }})</a></li>
                        </ul>
...
{{--                                        <a class="btn btn-sm btn-dark" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="First Priority Detail" data-content="First priority are those rider that have DRIVING LICENCE, TAKING COMPANY VISA, VISIT VISA">--}}
{{--                                            <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>--}}
{{--                                            </a>--}}

                                            <button class="btn btn-sm btn-dark m-1" type="button" data-toggle="tooltip" data-placement="top" title="First priority are those rider that have DRIVING LICENCE, TAKING COMPANY VISA, VISIT VISA">
                                                <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>
                                            </button>
                                ...
                                <div class="table-responsive">
                                    <table class="display table table-sm table-striped text-10 table-bordered" id="datatable_first_priority">
                                        <thead >
                                        <tr>
                                            <th scope="col">#</th>
...
{{--                                        <a class="btn btn-sm btn-dark" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Second Priority Detail" data-content="Second priority are those rider that have DRIVING LICENCE, TAKING COMPANY VISA, OWN VISA">--}}
{{--                                            <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>--}}
{{--                                        </a>--}}

                                        <button class="btn btn-sm btn-dark m-1" type="button" data-toggle="tooltip" data-placement="top" title="Second priority are those rider that have DRIVING LICENCE, TAKING COMPANY VISA, OWN VISA">
                                            <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>
                                        </button>
                                ...
                                <div class="table-responsive">
                                    <table class="display table table-striped table-sm text-10 table-bordered" id="datatable_second_priority">
                                        <thead >
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">Name</th>
...
{{--                                        <a class="btn btn-sm btn-dark" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" title="Third Priority Detail" data-content="Third priority are those rider that have NO DRIVING LICENCE, NOT TAKING COMPANY VISA, NO OWN VISA">--}}
{{--                                            <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>--}}
{{--                                        </a>--}}

                                        <button class="btn btn-sm btn-dark m-1" type="button" data-toggle="tooltip" data-placement="top" title="Third priority are those rider that have NO DRIVING LICENCE, NOT TAKING COMPANY VISA, NO OWN VISA">
                                            <span class="ul-btn__icon"><i class="i-Speach-Bubble-Asking"></i></span>
                                        </button>
                                ...
                                <div class="table-responsive">
                                    <table class="display table table-striped table-sm text-10 table-bordered" id="datatable_third_priority">
                                        <thead >
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">Name</th>
                            ...
                            <div class="tab-pane fade" id="referal_priority" role="tabpanel" aria-labelledby="referal-icon-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="display table table-striped table-sm text-10 table-bordered" id="datatable_referal_priority">
                                        <thead >
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">Name</th>
                                        ...
                                        @foreach($referal_users as $career)
...
{{--    display modal date jquery end--}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#datatable_first_priority,  #datatable_second_priority, #datatable_third_priority,  #datatable_referal_priority').DataTable( {
        ...
        $(document).ready(function () {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                if(split_ab[1]=="second_priority"){
                    // alert(split_ab[1]);
                  var table_exist =  $('#datatable_second_priority').DataTable();
                    table_exist.destroy();
                    $('#datatable_second_priority select').remove();
                    ...
                    table.columns.adjust().draw();
                     ...
                     $('#datatable_'+split_ab[1]).DataTable().destroy();
                    // $('#datatable_'+split_ab[1] select').remove();
                    $('#datatable_'+split_ab[1]+' .filtering_source_from select').remove();
        ...
        function second_priority_filter_color(priority='',color=''){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#datatable_second_priority tbody').html(response.html);

                    $("#datatable_second_priority .filtering_source_from select").remove();
        ...
        function third_priority_filter_color(priority='',color=''){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#datatable_third_priority .filtering_source_from select").remove();
        ...
        function referal_priority_filter_color(priority='',color=''){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#datatable_referal_priority .filtering_source_from select").remove();
