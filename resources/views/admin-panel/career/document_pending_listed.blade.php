        ...
        <div class="card text-left">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link text-10 " id="license_tab" data-toggle="tab" href="#lincenseTab" role="tab" aria-controls="lincenseTab" aria-selected="false">With License({{ $license->count() ? $license->count()  : '0'   }}) </a></li>
                    <li class="nav-item"><a class="nav-link text-10" id="no_license_tab" data-toggle="tab" href="#NolincenseTab" role="tab" aria-controls="NolincenseTab" aria-selected="false">WithOut License({{ $not_license->count() ? $not_license->count()  : '0'   }}) </a></li>
                </ul>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show" id="lincenseTab" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            ...
                            <table class="display table table-striped text-10 table-bordered table-sm" id="datatable_career_license">
                                <thead >
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Name</th>
...
{{--                                    <th scope="col">Refer By</th>--}}
                    ...
                    <div class="tab-pane fade show" id="NolincenseTab" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            ...
                            <table class="display table table-striped text-10 table-bordered table-sm" id="datatable_career_nolicense">
                                <thead >
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Name</th>
...
@section('js')
        ...
        $(document).ready(function () {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                if(currentTab=="home-basic-tab"){
                    ...
                    tabs_table("document_pending_referals","","datatable_career_referals");
                    get_color_block_count("document_pending_referals","referal_priority_hours_24_block","referal_priority_hours_48_block","referal_priority_hours_72_block","referal_priority_less_24_block");
    ...
    <script>
        ...
        $("#first_priority_hours_24_block").click(function () {
            ...
            first_priority_filter_color("document_pending","orange");
        });

        $("#first_priority_hours_48_block").click(function () {

            first_priority_filter_color("document_pending","pink");
        });

        $("#first_priority_hours_72_block").click(function () {

            first_priority_filter_color("document_pending","red");
        });

        $("#first_priority_less_24_block").click(function () {

            first_priority_filter_color("document_pending","white");
        });

        $("#remove_apply_filter_two").click(function () {

            first_priority_filter_color("document_pending","");
            get_color_block_count("document_pending ","first_priority_hours_24_block","first_priority_hours_48_block","first_priority_hours_72_block","first_priority_less_24_block");
        });
        ...
        $("#referal_priority_hours_24_block").click(function () {
            ...
            referal_priority_filter_color("document_pending_referals","orange");
        });

        $("#referal_priority_hours_48_block").click(function () {

            referal_priority_filter_color("document_pending_referals","pink");
        });

        $("#referal_priority_hours_72_block").click(function () {

            referal_priority_filter_color("document_pending_referals","red");
        });
