...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Passport Handler Status</a></li>
            <li>Update Passport Handler Status</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('passport_handler.store')  }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <select class="form-control  " name="status_id" id="status_id" required >
                                    <option value="">select an option</option>
                                    @foreach($passport_handlers as $handler)
                        ...
                        <table class="display table table-striped table-bordered" id="datatable">
                            ...
                            <tbody>
                                ...
                                @foreach($passport_statuses as $status)
                                    <tr>
                                        <th scope="row">1</th>
                                    <td>{{ $status->passport_detail->passport_no }}</td>
                                    <td>{{ $status->passport_status->name }}</td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#passport_id").change(function () {
                ...
                var html_both = '<option value="1">Issue</option><option value="2">Collected</option>';
                var html_collect = '<option value="1">Issue</option>';
                var html_issue = '<option value="2">Collected</option>';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response=="1"){
                            $("#status_id").append(html_issue);
                        }else if(response=="2"){
                            $("#status_id").append(html_collect);
                        }else{
                            $("#status_id").append(html_both);
                        }
