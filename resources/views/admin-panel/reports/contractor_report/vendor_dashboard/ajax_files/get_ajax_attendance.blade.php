...
<div class="table2">
    ...
    @foreach($platform_att as $row)
        @if($row['platform_id']=='15')

        {{--            in_array($row['platform_id'], auth()->user()->user_platform_id)--}}


            {{--            @if(in_array($row['platform_id'], auth()->user()->user_platform_id))--}}
            <div class="row">
                    ...
                    <div class="card card-profile-1 mb-4 mr-1">
                        <div class="card-body text-left">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  {{-- <p class="text-attr-title font-weight-bold mt-3 ml-4">Orders </p> --}}
                                     <p class="text-attr-digit ml-4 " style="margin-top: 25px;">{{$row['orders']}} </p>
                                     {{-- <p class="text-attr-digit ml-4 mt-0 mb-1" style="color: green">{{$row['orders']}} </p> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-profile-1 mb-4 mr-1">
                        <div class="card-body text-left">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    {{--                                            <p class="text-attr-title font-weight-bold mt-3 ml-4">Orders </p>--}}
                                    <p class="text-attr-digit txt-orders ml-4 mt-4">{{$row['total_rider']}} </p>
                                </div>
                            </div>
                        </div>
                    </div>
