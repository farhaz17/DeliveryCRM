...
@section('content')
    ...
    <div class="card col-lg-9 offset-lg-1 mb-2">
        ...
        <table class="table" id="datatable"  style="width: 100%">
            ...
            <tr>
                <th scope="col" style="width: 100px">4PL Contractor</th>
                ...
                <th scope="col" style="width: 100px">SIM</th>
            ...
            @foreach($agreement as $row)
                <tr>
                    <td> {{$row->passport->agreement->fourpl_contractor->name}}</td>
                    ...
                    {{--------------------------------------------------------------------------------------}}
                    <td>{{isset($row->passport->bike_checkin()->bike_plate_number->plate_no) ? ($row->passport->bike_checkin()->bike_plate_number->plate_no) : 'N/A'}}</td>

                    <td>
                        <a class="btn btn-primary btn-sm mr-2 pass_btn_cls-1" id="{{$row->passport->id}}" href="javascript:void(0)">
                            View Detail
                        </a>
...
@section('js')
    ...
    <script>
        $(".pass_btn_cls-1").click(function(){
            ...
            $.ajax({
                url: "{{ route('contract_report_show') }}",
                method: 'POST',
                dataType: 'json',
