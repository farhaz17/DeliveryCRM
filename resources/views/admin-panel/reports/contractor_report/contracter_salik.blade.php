...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card-title mb-3">Vendor Salik</div>
        <div class="card">
            <div class="card-body">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function verify_load_data(from_date= '', end_date= '',type='',platform='', all_com=''){
            ...
            $.ajax({
                url: "{{ route('get_4pl_salik_detail') }}",
                method: 'POST',
                dataType: 'json',
                beforeSend: function () {
                    $(".loading_msg").show();
                },
                data:{from_date:from_date, end_date:end_date,verify:"verify table",type:type,company_id:platform,all_com:all_com,_token: "{{ csrf_token() }}"},
    ...
    <script>
        ...
        function get_main_digits(start_date , end_date='',company_id=''){
            ...
            $.ajax({
                url: "{{ route('salikget_salik_total_amount_ajax_4pl') }}",
                method: 'POST',
                data: {start_date: start_date ,end_date:end_date,company_id:company_id, _token:token,all_com:all_com},
                success: function(response) {
