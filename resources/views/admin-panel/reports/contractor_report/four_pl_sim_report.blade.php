...
@section('content')
    ...
    <div class="card col-lg-10 offset-lg-1 mb-2">
        ...
        <table class="table table-striped" id="datatable"  style="width: 100%">
            ...
            <tr>
                <th scope="col" style="width: 100px">SIM Assigned To 4PL</th>
            ...
            @foreach($agreement as $row)
                @if(isset($row->passport->sim_checkin()->telecome->account_number))
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm mr-2 pass_btn_cls-1" id="{{$row->passport->sim_checkin()->telecome->id}}" href="javascript:void(0)">
                                View Detail
                            </a>
...
@section('js')
    ...
    <script>
        $(".pass_btn_cls-1").click(function(){
            ...
            $.ajax({
                url: "{{ route('contractor_sim_report_show') }}",
                method: 'POST',
                dataType: 'json',
