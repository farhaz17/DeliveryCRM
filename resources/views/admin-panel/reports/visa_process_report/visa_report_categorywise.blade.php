                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card text-left">
                                <div class="card-body">
                                    <h4 class="card-title mb-3">Visa Process Categorywise</h4>

                                    <ul class="nav nav-tabs containter" id="dropdwonTab" >
                                        @foreach($data as $res)
                                        <li class="nav-item" >
                                            <a  class="nav-link @if($res['id']=='1') active show  @else  @endif text-white btn-primary  tab-main ml-2 mb-2" style="padding:5px" id="company-{{$res['id']}}-tab" data-toggle="tab" href="#company-{{$res['id']}}"
...
{{-- -----------------------first tab data ends here ---------------------------------------}}
                                            </div>
                                            {{-- <div class="company_div-{{$res->id}}"></div> --}}
                                        </div>
                                        @endforeach
...
<script>
  $(document).on('click', '#company-1-tab', function(){
                   ...
                   $("#company-17-tab").css("background-color", "#663399");
                   $("#company-18-tab").css("background-color", "#663399");
                   $("#company-19-tab").css("background-color", "#663399");
                    $.ajax({
                        url: "{{ route('get_visa_category_details') }}",
                        method: 'POST',
                        dataType: 'json',
                        ...
                        success: function (response) {
                              ...
                              $('.company_div-17').empty();
                              $('.company_div-18').empty();
                              $('.company_div-19').empty();
                            ...
                            var table4 = $('#datatable-4-1').DataTable({
                                  "autoWidth": true,
                              });
                              ...
                              var table5 = $('#datatable-5-1').DataTable({
                                  "autoWidth": true,
                              });
                              ...
                              var table6 = $('#datatable-6-1').DataTable({
                                  "autoWidth": true,
                              });
                              ...
                              var table7 = $('#datatable-7-1').DataTable({
                                  "autoWidth": true,
                              });
                   ...
                   $("#company-19-tab").css("background-color", "#663399");
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                              ...
                              var table4 = $('#datatable-4-2').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-2').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-2').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-2').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              var table4 = $('#datatable-4-3').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-3').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-3').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-3').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-4').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-4').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-4').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-4').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-5').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-5').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-5').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-5').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-6').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-6').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-6').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-6').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-7').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-7').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-7').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-7').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              var table4 = $('#datatable-4-8').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-8').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-8').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-8').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-9').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-9').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-9').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-9').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();;
                              var table4 = $('#datatable-4-10').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-10').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-10').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-10').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              table3.columns.adjust().draw();
                              var table4 = $('#datatable-4-14').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-14').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-14').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-14').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              var table4 = $('#datatable-4-15').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-15').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-15').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-15').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              var table4 = $('#datatable-4-16').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-16').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-16').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-16').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
...
<script>
    $(document).on('click', '#company-17-tab', function(){
                     var company_id='17';
                     var token = $("input[name='_token']").val();
                     $("#company-1-tab").css("background-color", "#663399");
                   $("#company-2-tab").css("background-color", "#663399");
                   ...
                   $("#company-15-tab").css("background-color", "#663399");
                   $("#company-16-tab").css("background-color", "#663399");
                   $("#company-17-tab").css("background-color", "black");
                   $("#company-18-tab").css("background-color", "#663399");
                   $("#company-19-tab").css("background-color", "#663399");
                      $.ajax({
                          url: "{{ route('get_visa_category_details') }}",
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              $('.company_div-17').append(response.html);
                              $('.company_div-17').show();
                              $("body").removeClass("loading");

                              var table1 = $('#datatable-1-17').DataTable({
                                  "autoWidth": true,
                              });
                              table1.columns.adjust().draw();

                              var table2 = $('#datatable-2-17').DataTable({
                                  "autoWidth": true,
                              });
                              table2.columns.adjust().draw();
                              ...
                              var table3 = $('#datatable-3-17').DataTable({
                                  "autoWidth": true,
                              });
                              table3.columns.adjust().draw();

                              var table4 = $('#datatable-4-17').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-17').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-17').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-17').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
...
<script>
    $(document).on('click', '#company-18-tab', function(){
                     var company_id='18';
                     var token = $("input[name='_token']").val();
                     $("#company-1-tab").css("background-color", "#663399");
                   $("#company-2-tab").css("background-color", "#663399");
                   ...
                   $("#company-16-tab").css("background-color", "#663399");
                   $("#company-17-tab").css("background-color", "#663399");
                   $("#company-18-tab").css("background-color", "black");
                   $("#company-19-tab").css("background-color", "#663399");
                      $.ajax({
                          url: "{{ route('get_visa_category_details') }}",
                          method: 'POST',
                          ...
                          success: function (response) {
                            $('.company_div-1').empty();
                              ...
                              $('.company_div-18').append(response.html);
                              $('.company_div-18').show();
                              $("body").removeClass("loading");

                              var table1 = $('#datatable-1-18').DataTable({
                                  "autoWidth": true,
                              });
                              table1.columns.adjust().draw();

                              var table2 = $('#datatable-2-18').DataTable({
                                  "autoWidth": true,
                              });
                              table2.columns.adjust().draw();
                              ...
                              var table3 = $('#datatable-3-18').DataTable({
                                  "autoWidth": true,
                              });
                              table3.columns.adjust().draw();

                              var table4 = $('#datatable-4-18').DataTable({
                                  "autoWidth": true,
                              });
                              table4.columns.adjust().draw();
                              ...
                              var table5 = $('#datatable-5-18').DataTable({
                                  "autoWidth": true,
                              });
                              table5.columns.adjust().draw();
                              ...
                              var table6 = $('#datatable-6-18').DataTable({
                                  "autoWidth": true,
                              });
                              table6.columns.adjust().draw();
                              ...
                              var table7 = $('#datatable-7-18').DataTable({
                                  "autoWidth": true,
                              });
                              table7.columns.adjust().draw();
                          }
      ...
      <script>
        $(document).on('click', '#company-19-tab', function(){
                         var company_id='19';
                         var token = $("input[name='_token']").val();
                         $("#company-1-tab").css("background-color", "#663399");
                       $("#company-2-tab").css("background-color", "#663399");
                       ...
                       $("#company-17-tab").css("background-color", "#663399");
                       $("#company-18-tab").css("background-color", "#663399");
                       $("#company-19-tab").css("background-color", "black");
                          ...
                          $.ajax({
                              ...
                              success: function (response) {
                                $('.company_div-1').empty();
                                  ...
                                  $('.company_div-19').append(response.html);
                                  $('.company_div-19').show();
                                  $("body").removeClass("loading");

                                  var table1 = $('#datatable-1-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table1.columns.adjust().draw();

                                  var table2 = $('#datatable-2-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table2.columns.adjust().draw();
                                  ...
                                  var table3 = $('#datatable-3-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table3.columns.adjust().draw();

                                  var table4 = $('#datatable-4-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table4.columns.adjust().draw();
                                  ...
                                  var table5 = $('#datatable-5-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table5.columns.adjust().draw();
                                  ...
                                  var table6 = $('#datatable-6-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table6.columns.adjust().draw();
                                  ...
                                  var table7 = $('#datatable-7-19').DataTable({
                                      "autoWidth": true,
                                  });
                                  table7.columns.adjust().draw();
                              }
...
<script>
    $(document).ready(function () {
        $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
            ...
            else if(split_ab=="second-tab"){
                var table = $('#datatable-2-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="third-tab"){
                var table = $('#datatable-3-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="fourth-tab"){
                var table = $('#datatable-4-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="fifth-tab"){
                var table = $('#datatable-5-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="sixth-tab"){
                var table = $('#datatable-6-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="seventh-tab"){
                var table = $('#datatable-6-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
            else if(split_ab=="ninth-tab"){
                var table = $('#datatable-7-1').DataTable();
                $('#container').css( 'display', 'block' );
                table.columns.adjust().draw();
            }
...
<script>
    $(document).on('click', '#first-tab', function(){
                     ...
                     $("#first-tab").css("background-color", "red");
                     $("#second-tab").css("background-color", "#003473");
                     $("#third-tab").css("background-color", "#003473");
                     $("#fourth-tab").css("background-color", "#003473");
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "#003473");
                     $("#ninth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#second-tab', function(){
                     ...
                     $("#first-tab").css("background-color", "003473");
                     $("#second-tab").css("background-color", "red");
                     $("#third-tab").css("background-color", "#003473");
                     $("#fourth-tab").css("background-color", "#003473");
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#third-tab', function(){
                     ...
                     $("#first-tab").css("background-color", "#003473");
                     $("#second-tab").css("background-color", "#003473");
                     $("#third-tab").css("background-color", "red");
                     $("#fourth-tab").css("background-color", "#003473");
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#fourth-tab', function(){

                     $("#first-tab").css("background-color", "#003473");
                     $("#second-tab").css("background-color", "#003473");
                     $("#third-tab").css("background-color", "#003473");
                     $("#fourth-tab").css("background-color", "red");
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "#003473");
                     $("#ninth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#fifth-tab', function(){

                     $("#first-tab").css("background-color", "#003473");
                     $("#second-tab").css("background-color", "#003473");
                     $("#third-tab").css("background-color", "#003473");
                     $("#fourth-tab").css("background-color", "#003473");
                     $("#fifth-tab").css("background-color", "red");
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "#003473");
                     $("#ninth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#sixth-tab', function(){
                     ...
                     $("#fourth-tab").css("background-color", "#003473");
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "red");
                     $("#seventh-tab").css("background-color", "#003473");
                     $("#ninth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#seventh-tab', function(){
                     ...
                     $("#fifth-tab").css("background-color", "#003473");
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "red");
                     $("#ninth-tab").css("background-color", "#003473");
...
<script>
    $(document).on('click', '#ninth-tab', function(){
                     ...
                     $("#sixth-tab").css("background-color", "#003473");
                     $("#seventh-tab").css("background-color", "#003473");
                     $("#ninth-tab").css("background-color", "red");
