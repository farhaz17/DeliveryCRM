                    ...
                    <div class="table-responsive">
                        <table class="display table table-striped table-bordered table-sm text-12" id="datatable_not_employee">
                            ...
                            <tr>
                                ...
                                <th scope="col">Days Left For Fine</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('fine-or-impound') }}" method="post">
                        @csrf
                            ...
                            <div>
                                ...
                                <input type="date" class="form-control fine-date" name="fine_date">
                            </div>
                            <div>
