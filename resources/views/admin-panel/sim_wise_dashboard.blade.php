...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">SIM Module</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-2">
        ...
        <div class="row">
            <div class="col-2 mb-2">
                <div class="card card-icon bg-danger">
                    <a href="{{ route('sim_master') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Gear"></i>
                        <span class="item-name">SIM</span>
                    </a>  
                </div>
            </div>
            <div class="col-2 mb-2">
                <div class="card card-icon bg-danger">
                    <a href="{{ route('sim_package.create') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Gear"></i>
                        <span class="item-name">SIM Package</span>
                    </a>  
                </div>
            </div>
            <div class="col-2 mb-2">
                <div class="card card-icon bg-danger">
                    <a href="{{ route('sim_card_replace.create') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Gear"></i>
                        <span class="item-name">SIM Replacement</span>
                    </a>  
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-2 mb-2">
                <div class="card card-icon bg-primary">
                    <a href="{{ route('sim_master') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Library header-icon"></i>
                        <span class="item-name">SIM Reports</span>
                    </a>  
                </div>
            </div>
            <div class="col-2 mb-2">
                <div class="card card-icon bg-primary">
                    <a href="{{ route('sim_package.index') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Library header-icon"></i>
                        <span class="item-name">Package Reports</span>
                    </a>  
                </div>
            </div>            
            <div class="col-2 mb-2">
                <div class="card card-icon bg-primary">
                    <a href="{{ route('sim_card_replace.index') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Library header-icon"></i>
                        <span class="item-name">Replacement Report</span>
                    </a>  
                </div>
            </div>
        </div>
