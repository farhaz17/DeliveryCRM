    ...
    <div class="row card-body pb-2">
        ...
        <div class="col-md-12 text-center" >
            <button class="btn btn-primary btn-sm ajax_talabat_user_wise_riders_cod_buttons"
                data-get_button_url="{{ route('ajax_talabat_user_wise_riders_cod_follow_up_buttons',['type' =>'cod_collection_buttons'])}}" >
                Collections (
            ...
            <button class="btn btn-info btn-sm ajax_talabat_user_wise_riders_cod_buttons"
                data-get_button_url="{{ route('ajax_talabat_user_wise_riders_cod_follow_up_buttons',['type' =>'cod_balance_buttons'])}}">
                Balances (
