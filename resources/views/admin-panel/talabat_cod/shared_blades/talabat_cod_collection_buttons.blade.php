...
<div id="codCollectionbelow300CityWiseSubButtonHolder" style="display:none">
    ...
    @endphp
    <a class="btn btn-success btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_analysis',['city_id'=>  $city->id ,'searchBy'=>'current_day_cod', 'starting_amount' => 0, 'ending_amount' => 300, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" id="">
...
<div id="codCollectionAbove300CityWiseSubButtonHolder" style="display:none">
    ...
    @endphp
    <a class="btn btn-danger btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_analysis',['city_id'=>  $city->id ,'searchBy'=>'current_day_cod', 'starting_amount' => 300, 'ending_amount' => 10000, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" id="">
