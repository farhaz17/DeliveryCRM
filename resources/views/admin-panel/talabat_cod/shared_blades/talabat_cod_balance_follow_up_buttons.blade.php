...
<hr class="m-2">
<div class="cod_balance_button_holders text-center" id="codCollectionbelow500CityWiseSubButtonHolder" style="display:none">
    ...
    @endphp
    <a class="btn btn-success btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 0, 'ending_amount' => 499, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
...
<div class="cod_balance_button_holders text-center" id="codCollectionAbove500CityWiseSubButtonHolder" style="display:none">
    @forelse ($cities as $city)
    @php
    ...
    @endphp
    <a class="btn btn-success btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 500, 'ending_amount' => 999, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
...
<div class="cod_balance_button_holders text-center" id="codCollectionAbove1000CityWiseSubButtonHolder" style="display:none">
    @forelse ($cities as $city)
    @php
    ...
    @endphp
    <a class="btn btn-warning btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 1000, 'ending_amount' => 1499, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
...
<div class="cod_balance_button_holders text-center" id="codCollectionAbove1500CityWiseSubButtonHolder" style="display:none">
    @forelse ($cities as $city)
    @php
    ...
    @endphp
    <a class="btn btn-danger btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 1500, 'ending_amount' => 1999, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
...
<div class="cod_balance_button_holders text-center" id="codCollectionAbove2000CityWiseSubButtonHolder" style="display:none">
    @forelse ($cities as $city)
    @php
        ...
        $codBalanceAbove1500CityWiseSubButtonNet = $codBalanceAbove1500CityWiseSubButton - ($internal_cod_adjustments_cash + $internal_cod_adjustments_bank);
    @endphp
    <a class="btn btn-danger btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 2000, 'ending_amount' => 2499, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
        {{ $city->city_code }} ( {{ number_format( $codBalanceAbove1500CityWiseSubButtonNet, 2) }} AED /  {{ $codBalanceAbove1500CityWiseSubButtonCount }} )
    </a>
    @empty
...
<div class="cod_balance_button_holders text-center" id="codCollectionAbove2500CityWiseSubButtonHolder" style="display:none">
    @forelse ($cities as $city)
    @php
    ...
    @endphp
    <a class="btn btn-danger btn-sm get_cod_table mb-2 cod_amount_range_buttons" href="{{ route('ajax_talabat_user_wise_riders_cod_follow_up',['city_id'=>  $city->id ,'searchBy'=>'current_day_balance', 'starting_amount' => 2500, 'ending_amount' => 10000, 'dc_id' => $dc_id, 'adjustment_type' => $adjustment_type]) }}" >
...
<script>
    $('#Balancebelow500CodCityWise').click(function(){
        ...
        $('#codCollectionbelow500CityWiseSubButtonHolder').show(300)
    });
    ...
    $('#BalanceAbove500CodCityWise').click(function(){
        ...
        $('#codReportTable_wrapper').empty()
        $('.cod_balance_button_holders').hide(300);
        $('#codCollectionAbove500CityWiseSubButtonHolder').show(300)
    });
    ...
    $('#BalanceAbove1000CodCityWise').click(function(){
        ...
        $('#codReportTable_wrapper').empty()
        $('.cod_balance_button_holders').hide(300);
        $('#codCollectionAbove1000CityWiseSubButtonHolder').show(300)
    });
    $('#BalanceAbove1500CodCityWise').click(function(){
        ...
        $('#codReportTable_wrapper').empty()
        $('.cod_balance_button_holders').hide(300);
        $('#codCollectionAbove1500CityWiseSubButtonHolder').show(300)
    });
    ...
    $('#BalanceAbove2000CodCityWise').click(function(){
        ...
        $('#codReportTable_wrapper').empty()
        $('.cod_balance_button_holders').hide(300);
        $('#codCollectionAbove2000CityWiseSubButtonHolder').show(300)
    });
    ...
    $('#BalanceAbove2500CodCityWise').click(function(){
        ...
        $('#codReportTable_wrapper').empty()
        $('.cod_balance_button_holders').hide(300);
        $('#codCollectionAbove2500CityWiseSubButtonHolder').show(300)
    });
</script>
