...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Talabat COD Upload</li>
        </ol>
    </nav>
    ...
    <div class="row pb-2">
        <div class="col-md-12 row m-auto">
            ...
            <div class="card col-md-6 border">
                <div class="card-body">
                    <div class="card-title">Talabat COD Upload Form</div>
                    <form method="post" enctype="multipart/form-data" action="{{ route('talabat_cod.store') }}"  aria-label="{{ __('Upload') }}" >
                        @csrf
                        ...
                        <div class="col-md-4 form-group"  style="float: right;" >
                            <a href="{{ asset('assets/sample/Cod/talabat_cod/talabat_cod_sample.xlsx') }}" class="float-right" target="_blank">( Download Sample File )</a>
                        </div>
            ...
            <div class="card col-md-6 border">
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('talabat_cod_deduction') }}"  aria-label="{{ __('Upload') }}" >
                        ...
                        <div class="col-md-4 form-group"  style="float: right;" >
                            <a href="{{ asset('assets/sample/Cod/talabat_cod/talabat_cod_deduction_sample.xlsx') }}" class="float-right" target="_blank">( Download Sample File )</a>
                        </div>
                        <div class="col-md-12 form-group mb-3">
                            <button class="btn btn-sm btn-info float-right" name="upload_or_delete" type="submit" value="upload">Upload</button>
    ...
    @endif
    <div class="row pb-2">
        <div class="col-md-12 card-title">Talabat COD Calender</div>
...
@section('js')
    ...
    <script>
        function  make_calender() {
            ...
            $.ajax({
                url: "{{ route('render_calender_talabat_cod') }}",
                method: 'POST',
                data: {_token:token},
