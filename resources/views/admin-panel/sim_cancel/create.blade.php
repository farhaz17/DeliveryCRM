...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cancel Sim</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3  text-danger">Cancel Sim</div>
                    <form method="post" action="{{ route('save_cancel_sim')  }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row ">
                            <div class="col-md-4 form-group mb-3 append_div">
                                <label for="keyword">Search Sim Number <b>(Required)</b></label>
                                <select class="form-control" name="sim_id" id="sim_id">
                                       <option> </option>
