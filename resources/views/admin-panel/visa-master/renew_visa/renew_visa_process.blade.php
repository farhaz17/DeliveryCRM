...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li><a href="">Renew Visa Proces</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input class="form-control form-control-sm  typeahead" readonly id="keyword" value="{{ isset($_GET['passport_id']) ? $_GET['passport_id'] : '' }}" autocomplete="off" type="text" required  name="name" placeholder="search..." aria-label="Username" aria-describedby="basic-addon1">
                                        ...
                                        <input class="form-control" id="agreed_id" name="agreed_id" value="{{ isset($_GET['agreed_id']) ? $_GET['agreed_id'] : '' }}" type="hidden" value="" />
                                    </div>
                                </div>
                            </div>
...
<script>
  $(document).on('click', '.sugg-drop', function(){
                    ...
                    var agreed_id = $("input[name='agreed_id']").val();
                    var keyword  =   $(this).find('#drop-name').text();


                    $.ajax({
                        url: "{{ route('renew_visa_process_names') }}",
                        method: 'POST',
                        dataType: 'json',
...
<script>
    function contractTyping(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_process_contract_typing') }}",
                        method: 'POST',
                        dataType: 'json',
...
<script>
    function contract_submission(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_process_contract_sub') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
    ...
    function medical(id)
        {
            ...
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_process_medical') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
    function emiratesIdApply(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_emirates_id_apply') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
    function visaStamping(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_stamping') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
    function visaPasting(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_pasting') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
      function emiratesIDreceive(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('renew_visa_eid_rec') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
    function emiratesIDHandover(id)
      {
          var id=id;
          var token = $("input[name='_token']").val();
          $.ajax({
                      url: "{{ route('renew_visa_eid_handover') }}",
                      method: 'POST',
                      dataType: 'json',
                      data:{id:id,_token:token},
                      beforeSend: function () {
