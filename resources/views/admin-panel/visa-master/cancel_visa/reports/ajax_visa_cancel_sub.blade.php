<h4 class="card-title mb-3"> <span class="badge badge-primary m-2">Visa Cancel Submission </span></h4>
<table class="display table table-striped table-bordered table-sm text-10" id="datatable-submission" width="100%">
    <thead>
    <tr>
    ...
    <tbody>
    @foreach($visa_cancel_sub as $row)
        <tr>
