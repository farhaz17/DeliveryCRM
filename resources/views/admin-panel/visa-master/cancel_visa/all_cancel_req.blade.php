        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active show" id="home-basic-tab" data-toggle="tab" href="#homeBasic" role="tab" aria-controls="homeBasic" aria-selected="true">Cancel Request</a></li>
                    <li class="nav-item"><a class="nav-link" id="profile-basic-tab" data-toggle="tab" href="#profileBasic" role="tab" aria-controls="profileBasic" aria-selected="false">Removed Cancel Requests</a></li>
                </ul>
                <div class="tab-content" id="myTabContent">
                                ...
                                @foreach($req as $res)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-target=".bd-example-modal-lg" onclick="revoke_visa_cancel({{$res->id}})"
                                             type="button">
                    ...
                    <div class="tab-pane fade" id="profileBasic" role="tabpanel" aria-labelledby="profile-basic-tab">
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered table-sm text-10" id="datatable2" >
                                <thead>
                                <tr class="t-row">
                                    <th scope="col">Name</th>
                                    <th scope="col">Passport No</th>
                                ...
                                @foreach($remove as $res)
                                    <tr>
                                        ...
                                        <td>{{ isset($res->created_at)?$res->created_at:""}}</td>
                                        <td>{{ isset($res->user_detail->name)?$res->user_detail->name:""}}</td>
                                        <td>{{ isset($res->removed_detail->name)?$res->removed_detail->name:""}}</td>
            ...
            <div class="modal-content">
                <form action="" id="startForm" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle-1">Remove Visa Cancel Request</h5>
                    ...
                    <div class="modal-body">
                        ...
                        {{method_field('GET')}}
                      <strong>
                           <h5> Are you sure want to remove cancel visa request?</h5>
                      </strong>
                    </div>
...
@section('js')
    ...
    <script>
        function revoke_visa_cancel(id)
                       {
                           var id = id;
                           var url = '{{ route('cancel_request_revoke', ":id") }}';
