...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <div class="card-title"> <span class="badge badge-primary">Process Pending Payment Details  </span></div>
    <div class="row">
        ...
        <div class="card mb-4 step-cards">
            <div class="card-body">
                <div class="content">
                    ...
                    <p class="step_name-text font-weight-bold mt-2 ml-0 mb-0" >{{$row['step_name']}}</p>
...
//   console.log(this.id);
        ...
        $.ajax({
                        url: "{{ route('get_renew_visa_payment_detail') }}",
                        method: 'POST',
                        dataType: 'json',
