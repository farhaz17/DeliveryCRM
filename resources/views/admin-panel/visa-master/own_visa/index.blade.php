...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Own Visa Proces</a></li>
...
<script>
    function OwnVisaTyping(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('own_contract_typing') }}",
                        method: 'POST',
                        dataType: 'json',
...
<script>
    function ownVisaSub(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('own_contract_sub') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
...
<script>
    function OwnVisaLabour(id)
        {
            var id=id;
            var token = $("input[name='_token']").val();
            $.ajax({
                        url: "{{ route('own_labour') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{id:id,_token:token},
                        beforeSend: function () {
