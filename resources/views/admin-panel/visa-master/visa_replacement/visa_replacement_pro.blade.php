...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Visa Replacemnet Request PRO</a></li>
...
@section('js')
    ...
    <script type="text/javascript">
        var path = "{{ route('autocomplete_cancels_hr') }}";
...
<script>
  $(document).on('click', '.sugg-drop', function(){
                    ...
                    $.ajax({
                        url: "{{ route('replacement_visa_request_get_info') }}",
                        method: 'POST',
                        dataType: 'json',
                        data:{keyword:keyword,_token:token,sent_from:sent_from,hr_req:hr_req,pro_req:pro_req},
                        beforeSend: function () {
