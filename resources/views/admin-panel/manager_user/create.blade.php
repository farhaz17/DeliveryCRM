...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">Add New User OF User</div>
                    <form method="post" id="user_form" action="{{ route('manager_user.store') }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button class="btn btn-primary save-btn">Add User</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="datatable">
                        ...
                        <tbody>
                            ...
                            @foreach($manage_users as $ab)

                            <tr>
                                <th scope="row">1</th>
                                <td>{{ $ab->manager_user_detail->name }}</td>
                                <td>{{ count($ab->manager_user_detail->manager_users) }}</td>
                                <td  style="white-space: nowrap">
                                    <a class="text-success mr-2" href="{{ route('manager_user.edit',$ab->id) }}"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                                    <a class="text-info mr-2 details_user" id="{{ $ab->id }}"  href="javascript:void(0)"><i class="nav-icon i-Eye font-weight-bold"></i></a>
                                </td>
                            </tr>
                            @endforeach
