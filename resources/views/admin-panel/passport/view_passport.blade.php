...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li>Remain Additional info</li>
            <button class="btn btn-outline-primary mt-3 mb-3 m-sm-0 btn-rounded btn-sm" id="btn_additional_info">
                {{ $remain_additional_info }}
            </button>
        </ul>
                ...
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myIconTab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="home-icon-tab" data-toggle="tab" href="#not_employee" role="tab" aria-controls="not_employee" aria-selected="true"><i class="nav-icon i-File-Clipboard-Text--Image mr-1"></i>Active Passport({{ $passport->count() }})</a></li>
                            <li class="nav-item"><a class="nav-link" id="profile-icon-tab" data-toggle="tab" href="#taking_visa" role="tab" aria-controls="taking_visa" aria-selected="false"><i class="nav-icon i-Remove-Bag mr-1"></i>Cancel Passport({{ $cancel_passport->count() }})</a></li>
                        </ul>
                                    ...
                                    {{-- <table class="display table table-striped table-bordered" id="datatable_not_employee"> --}}
                                        ...
                                        @foreach($passport as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="text-success mr-2 renew_btn_cls" id="{{$row->id}}" href="javascript:void(0)"><i class="nav-icon i-Add-Window font-weight-bold"></i></a>
                                                    &nbsp;

{{--<!--                                                    <a class="text-success mr-2 pass_btn_cls-1" id="{{$row->id}}" href="javascript:void(0)"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>-->--}}
                                                    <a class="text-success mr-2" href="{{route('view_passport.edit',$row->id)}}"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                            ...
                            <div class="tab-pane fade" id="taking_visa" role="tabpanel" aria-labelledby="profile-icon-tab">
                                ...
                                <div class="table-responsive">
                                    {{-- <table class="display table table-striped table-bordered" id="datatable_taking_visa"> --}}
                                        <table class="table table-sm table-hover table-striped text-11 data_table_cls" id="datatable_taking_visa" >
                                        <thead>
                                        <tr>
                                            {{--                            <th scope="col">#</th>--}}
                                            <th scope="col" style="width: 100px">ID</th>
