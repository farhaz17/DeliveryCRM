...
<div class="card-body">
    <div class="card-title mb-3 col-12">Sim Package Reports</div>
    <div class="row">
        <table class="table table-sm table-hover table-striped text-11 data_table_cls" >
            ...
            <tbody>
                @forelse ($sim_packages as $sim_package)
                <tr>
                    <td>&nbsp;</td>
                    <td> {{ $sim_package->name ?? '' }} </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('sim_package.edit', $sim_package->id) }}">
