                ...
                <div class="card text-left">
                    <div class="card-body">
                        <h2 class="card-title mb-3">
                            <span class="badge badge-info">This fine did not match with our system </span>
                         </h2>
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered" id="datatable3" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($not_match as $row )
                                    @if($row['rider_name'] == '1')
                                        <tr>
                                            <td>{{$row['plate_number']}}</td>
                                            <td>{{$row['ticket_number']}}</td>
                                            <td>{{$row['ticket_date']}}</td>
                                            <td>{{$row['ticket_time']}}</td>
                                            <td>{{$row['fines_source']}}</td>
                                            <td>{{$row['ticket_fee']}}</td>
                                            <td>{{$row['offense']}}</td>
                                        </tr>
                                    @endif
