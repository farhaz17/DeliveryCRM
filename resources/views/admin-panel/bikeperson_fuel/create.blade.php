...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Fuel</a></li>
            <li>Add Bike/Person For Fuel</li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">Add Bike/Person For Fuel</div>
                    <form method="post" action="{{ route('bike_person_fuel.store')  }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-check-inline">
                                    <label class="radio radio-outline-success">
                                        <input type="radio" class="search_type_cls" checked  value="2" name="search_type" /><span>Passport Number</span><span class="checkmark"></span>
                                    </label>
                                </div>

                                <div class="form-check-inline">
                                    <label class="radio radio-outline-primary">
                                        <input type="radio" class="search_type_cls" value="1" name="search_type"  /><span>Bike</span><span class="checkmark"></span>
                                    </label>
                                </div>
                        ...
                        <div class="row ">
                            <div class="col-md-6 form-group mb-3 ">
                                <label for="repair_category" class="append_div">Search Passport/PPUID/ZDS Code</label><br>
                                <div class="input-group append_div">
                                ...
                                <div class="bike_div" style="display: none;">
                                <label for="repair_category "  class="bike_div_label"  style="display: none;">Select Bike</label><br>
                                <select class="form-control bike_div"  name="bike_id" id="bike_id" >
                            ...
                            <input type="hidden" name="user_passport_id" id="user_passport_id" />
