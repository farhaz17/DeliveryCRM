...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">Interview Invitation</a></li>
            <li>All Sent Interview Invitation</li>
        </ul>
    </div>
                ...
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered text-15 table-sm" id="datatable_not_employee">
