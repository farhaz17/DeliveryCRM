    ...
    <div class="card col-lg-12 mb-2">
        <div class="card-body">
            ...
            <div class="row form-group mb-6">
                ...
                @foreach($follow_up_statuses as $com)
                    ...
                    <div class="col-md-3 text-left mb-3 ">
                        <div class="form-check-inline">
                            <label class="radio radio-outline-primary">
                                @php
                                    $count_type_wise = $first_priority->where('applicant_status','=',$com->id)->count();
            ...
            <div class="card-title mb-3">Follow Up Reports</div>
...
@section('js')
    ...
    <script>
        function filter_reports(option,color=''){
            ...
            var token = $("input[name='_token']").val();
            $.ajax({
                url: "{{ route('ajax_filter_report_follow_up_candidate') }}",
                method: 'POST',
    ...
    <script>
        function get_color_block_count(option,orange_block_id, pink_block_id, red_block_id, white_block_id){
            ...
            var token = $("input[name='_token']").val();
            $.ajax({
                url: "{{ route('get_color_block_count_ajax_candidate') }}",
                method: 'POST',
