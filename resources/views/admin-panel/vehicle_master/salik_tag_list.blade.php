...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Salik Tag List</li>
    </ol>
</nav>
<div class="card col-md-12 mb-2">
<div class="card-body">
    <div class="card-title mb-3 col-12">Vehicle Salik Tag Reports</div>
    <div class="row">
        <table class="table table-sm table-hover table-striped text-11 data_table_cls" >
            ...
            <tbody>
                @forelse ($vehicle_salik_tags as $vehicle_salik_tag)
                <tr>
                    <td>&nbsp;</td>
                    <td> {{ $vehicle_salik_tag->tag_no ?? '' }} </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('vehicle_salik_tag.edit', $vehicle_salik_tag->id) }}">
