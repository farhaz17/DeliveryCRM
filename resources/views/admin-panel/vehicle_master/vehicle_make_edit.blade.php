...
<form action="{{ route('vehicle_make.update', $vehicleMake->id) }}" method="post" enctype="multipart/form-data">
@csrf
@method('put')
<div class="card col-md-8 offset-md-2 mb-2">
    <div class="card-body">
        <div class="card-title mb-3 col-12">Vehicle Make</div>
        <div class="row">
            <div class="col-md-4 form-group mb-1">
                <label for="name">Make Name</label>
                <input class="form-control form-control-sm" id="name" type="" placeholder="" name="name" value="{{ $vehicleMake->name ?? '' }}">
            </div>
            <div class="col-md-4 form-group mb-1">
