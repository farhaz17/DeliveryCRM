...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Plate Code List</li>
    </ol>
</nav>
<div class="card col-md-12 mb-2">
<div class="card-body">
    <div class="card-title mb-3 col-12">Vehicle Plate Code Reports</div>
    <div class="row">
        <table class="table table-sm table-hover table-striped text-11 data_table_cls" >
            ...
            <tbody>
                @forelse ($vehicle_plate_codes as $vehicle_plate_code)
                <tr>
                    <td>&nbsp;</td>
                    <td> {{ $vehicle_plate_code->plate_code ?? '' }} </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('vehicle_plate_code.edit', $vehicle_plate_code->id) }}">
