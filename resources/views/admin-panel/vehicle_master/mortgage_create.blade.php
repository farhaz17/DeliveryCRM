...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Vehicle Mortgage Register</li>
    </ol>
</nav>
<form action="{{ route('vehicle_mortgage.store') }}" method="post" enctype="multipart/form-data">
@csrf
