...
<div class="card-body">
    <div class="card-title mb-3 col-12">Vehicle Models Reports</div>
    <div class="row">
        <table class="table table-sm table-hover table-striped text-11 data_table_cls" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{ $model->name ?? '' }} </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('vehicle_model.edit', $model->id) }}">
