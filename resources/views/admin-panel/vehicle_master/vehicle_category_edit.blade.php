...
<form action="{{ route('vehicle_category.update', $vehicleCategory->id) }}" method="post" enctype="multipart/form-data">
@csrf
@method('put')
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4 form-group mb-1">
                ...
                <input class="form-control form-control-sm" id="name" type="" placeholder="" name="name" value="{{ $vehicleCategory->name ?? '' }}">
            </div>
            <div class="col-md-4 form-group mb-1">
