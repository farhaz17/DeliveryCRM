...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Attachment Label List</li>
    </ol>
</nav>
<div class="card col-md-12 mb-2">
<div class="card-body">
    <div class="card-title mb-3 col-12">Attachment Label Reports</div>
    <div class="row">
        <table class="table table-sm table-hover table-striped text-11 data_table_cls" >
            ...
            <tbody>
                @forelse ($attachmentLabel as $label)
                <tr>
                    <td>&nbsp;</td>
                    <td> {{ $label->name ?? '' }} </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('attachmentLabel.edit', $label->id) }}">
