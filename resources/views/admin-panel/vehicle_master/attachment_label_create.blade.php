...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Attachment Label</li>
    </ol>
</nav>
<form action="{{ route('attachmentLabel.store') }}" method="post">
@csrf
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4 form-group mb-1">
                <label for="name">Attachment Label Name</label>
