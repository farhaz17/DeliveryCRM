...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('customer_supplier_wise_dashboard',['active'=>'reports-menu-items']) }}">Customer | Supplier Reports</a></li>
        <li class="breadcrumb-item active" aria-current="page">Insurance List</li>
    </ol>
</nav>
<div class="card col-md-12 mb-2">
<div class="card-body">
    <div class="card-title mb-3 col-12">Vehicle Insurance Reports</div>
    <div class="row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="details-control">
                        <button class="btn btn-success btn-s btn-icon rounded-circle m-1 gone" style="font-size: 12px" id="go-{{ $insurance->id }}"  type="button">
                            <span class="ul-btn__icon"><i class="i-Add" id="ico-{{ $insurance->id}}"></i></span>
                        </button>
                       </td>
                    <td> {{ $insurance->name ?? '' }}
                        <div id='nested_table-{{$insurance->id}}'  style="display: none; margin-top:5px; margin-bottom:5px" >

                        </div>
                    </td>
                    <td>
                        <a class="text-success mr-2" href="{{ route('vehicle_insurance.edit', $insurance->id) }}">
    ...
    $(document).ready(function(){
        ...
        //  alert(splt_v[1]);
         ...
         if($("#nested_table-"+splt_v[1]).is(":visible")){
            ...
            var url = '{{ route('get_nested_network_data', ":id") }}';
