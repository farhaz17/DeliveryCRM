...
<div class="card col-md-8 offset-md-2 mb-2 pt-2 ">
    <div class="card-body">
        ...
        <hr>
        <h5>Etisalat</h5>
        <form action="{{route('company_master_utilities_etisalat_update', $etisalat->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-3 form-group mb-1">
                    ...
                    <select class="form-control form-control-sm select2" name="company_id" >
                        ...
                        @forelse($etisalat_companies as $company)
                            <option {{ $etisalat->company_id == $company->id ? 'selected' : '' }} value="{{ $company->id }}">{{ $company->name }} | {{ $company->trade_license_no }}</option>
                        @empty  
                ...
                <div class="col-md-3 form-group mb-1">
                    ...
                    <input class="form-control form-control-sm" value="{{ $etisalat->account_no ?? '' }}" id="" type="text" placeholder="" name="account_no" id="account_no">
                </div>
                <div class="col-md-3 form-group mb-1">
                    <label for="etisalat_party_id">Party No / Business No</label>
                    <input class="form-control form-control-sm" value="{{ $etisalat->etisalat_party_id ?? '' }}" id="etisalat_party_id" type="number" placeholder="" name="etisalat_party_id">
                </div>
                <div class="col-md-3 form-group mb-1">
