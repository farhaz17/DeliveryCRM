...
{{--        private chat end here--}}
        ...
        @if($ticke_info->is_checked=="0" || $ticke_info->is_checked=="2" && $ticke_info->is_approved=="1")
    ...
    <div class="col-md-7" style="height: 500px;" data-perfect-scrollbar="" data-suppress-scroll-x="true">
    ...
    @if($ticke_info->is_approved=="1")
        <div class="float-right">
            ...
            <form action="{{ route('approve_ticket_save') }}" id="form_management" method="post" class="float-right">
                ...
                <input type="hidden" name="primary_id"  value="{{ $ticke_info->id  }}">
                <button class="btn btn-info ml-2 status_btn" id="2" type="submit" >Assign To manager</button>
            </form>
