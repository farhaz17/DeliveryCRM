<div class="row">
    <div class="col-md-4">
        ...
        @if($ticke_info->is_checked=="0" || $ticke_info->is_checked=="2" && $ticke_info->is_approved=="7")
