...
@section('content')
    ...
    <div class="col-md-12 mb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group mb-3 "  style="float: left;"  >
...
@section('js')
    ...
    <script type="text/javascript">
        var path = "{{ route('autocomplete_bike') }}";
        $('input.typeahead').typeahead({
            ...
            highlighter: function (item, data) {
                ...
                if (data.type == 0) {
                    ...
                    html += '<span id="drop-name" class="font-weight-bold">' + data.name+'</span>';
                    html += '<div><hr></div>'
                    html += '<div><br></div>';
                    html += '<span id="drop-chasis" class="font-weight-bold">' + data.chasis+'</span>';
                    html += '<div><hr></div>';
                    html += '</div>';
                }
                else {
                    html += '<div class="col-lg-12 sugg-drop">';
                    html += '<span id="drop-name" class="font-weight-bold">' + data.bike_plate_no+'</span>';
                    html += '<div><hr></div>';
                    html += '<div><br></div>';
                    html += '<span id="drop-chasis" class="font-weight-bold">' + data.name+'</span>';
                    html += '</div>';
                }
