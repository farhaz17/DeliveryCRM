        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('save_order_rates') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input class="form-control form-control-rounded" id="amount" name="amount" value="" type="number" required />
                            </div>
                            <div class="col-md-12">
                    ...
                    <table class="display table table-striped table-bordered" id="datatable">
                        ...
                        <tbody>
                                ...
                                @foreach($rates as $rate)
                                    <tr>
                                        <th scope="row">1</th>
                                    <td>{{ $rate->platform->name }}</td>
                                    <td>{{ $rate->amount }}</td>
                                    <td>
                                        <a class="text-success mr-2" href="{{ route('order_rate_edit',$rate->id) }}"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                                    </td>
                                    </tr>
                                @endforeach
