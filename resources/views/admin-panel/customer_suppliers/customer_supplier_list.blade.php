...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('customer_supplier_wise_dashboard',['active'=>'reports-menu-items']) }}">Customer | Supplier Reports</a> / Contact List</li>
    </ol>
</nav>
<div class="card col-md-12  mb-2">
    <div class="card-body">
        <div class="card-title mb-3 col-12">Customer Supplier List</div>
            <div class="row">
                <table class="table table-hover table-striped table-sm text-11 datatable">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Imam Hasan</td>
                            <td>TelePhone: 364, Mobile: 646466, Email: abc@gmail.com</td>
                            <td>Accounts, Operation</td>
                        </tr>
                        <tr>
                            <td>1</td>
                            <td>Imam Hasan</td>
