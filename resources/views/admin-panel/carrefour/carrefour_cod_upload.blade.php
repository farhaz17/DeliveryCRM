...
<div class="col-md-12 form-group mb-3">
    <div class="card-title">
        <a href="{{ asset('assets/sample/Carrefour_Sample/carrefour.xlsx') }}" target="_blank">
...
<div class="col-md-12 mb-3">
    <div class="card text-left">
        <div class="card-body">
            <div class="card-title">Carrefour COD Upload</div>

            <form method="post" enctype="multipart/form-data" action="{{ route('carrefour_cod.store') }}"  aria-label="{{ __('Upload') }}">
                @csrf
                <div class="row">
...
@section('js')
    ...
    <script>
        $(document).ready(function (){
            ...
            $.ajax({
                url: "{{ route('carrefour_render_calender') }}",
                method: 'POST',
