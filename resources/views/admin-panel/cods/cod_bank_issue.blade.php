...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">COD BANK ISSUE Request</a></li>
            <li>COD Bank Issue Request  Detail</li>
        </ul>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myIconTabContent">
                            ...
                            <div class="tab-pane fade" id="rejected_visa" role="tabpanel" aria-labelledby="rejected-icon-tab">
                                ...
                                {{-- accordian end here--}}
                                <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="datatable_rejected_visa">
                                        <thead class="thead-dark">
                                        <tr>
                                            <th scope="col">Name</th>
                                            <th scope="col">Slip Number</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#reject_apply_filter").click(function(){
                ...
                var end_date  =   $("#end_date_not_rejected").val();
