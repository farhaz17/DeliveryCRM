...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            <li><a href="">COD BANK Request</a></li>
            <li>COD Bank Request Detail</li>
        </ul>
    </div>
    ...
    {{--    file upload modal--}}
    <div class="modal fade bd-example-modal-sm " id="file_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <form method="post" id="fileupload" action="{{ route('image_cods') }}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                        ...
                        <div class="tab-content" id="myIconTabContent">
                            <div class="tab-pane fade show active" id="not_employee" role="tabpanel" aria-labelledby="home-icon-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped table-bordered text-11" id="datatable_not_employee" style="width: 100%">
                                        <thead>
                                        <tr>
...
{{--                                            <th scope="col">Edit</th>--}}
                            ...
                            <div class="tab-pane fade" id="taking_visa" role="tabpanel" aria-labelledby="profile-icon-tab">
                                ...
                                {{-- accordian end here--}}
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped table-bordered text-11" id="datatable_taking_visa" style="width: 100%">
                                        <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                                            {{-- <th scope="col">Slip Number</th> --}}
                            ...
                            <div class="tab-pane fade" id="rejected_visa" role="tabpanel" aria-labelledby="rejected-icon-tab">
                                ...
                                {{-- accordian end here--}}
                                <div class="table-responsive">
                                    <table class="table table-sm table-striped table-bordered text-11" id="datatable_rejected_visa" style="width: 100%">
                                        <thead>
                                        <tr>
                                            <th scope="col">Name</th>
                                            {{-- <th scope="col">Slip Number</th> --}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#remove_apply_filter').click(function(){
                $('#start_date').val('');
                $('#end_date').val('');
                $('#platform').val(null).change('change');
                $('#datatable_not_employee').DataTable().destroy();
                $(".total").empty();
            ...
            $("#not_verify_apply_filter").click(function(){
                ...
                if(start_date != '' &&  end_date != '' && platform !='')
                {
                    var ab_table = $('#datatable_taking_visa').DataTable();
                    ab_table.destroy();
            ...
            $("#not_verify_remove_apply_filter").click(function(){
                ...
                $('#platform_two').val(null).change('change');
            ...
            $("#rejected_apply_filter").click(function(){
                ...
                if(start_date != '' &&  end_date != '' && platform!='' )
                {
                    ...
                    var token = $("input[name='_token']").val();
                        $.ajax({
                        url: "{{ route('ajax_total_cod_reject') }}",
                        method: 'POST',
                        data: {start: start_date,end: end_date,plat:platform ,_token:token},
                        success: function(response) {
            ...
            $("#rejected_remove_apply_filter").click(function(){
                ...
                $('#platform_three').val(null).change('change');
