...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">From DC to Transfer</div>
                    ...
                    <form method="post" action="{{ route('emirates_id_card.store')  }}"  enctype="multipart/form-data">
                        ...
                        <div class="row display_remain_div" style="display: none;" >
                            <div class="col-md-4 form-group mb-3">
                                <label for="repair_category" class="font-weight-bold">Total Riders of DC by Platform</label>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">To TRANSFER</div>
                    <div class="row to_display_dc_remain_div" >
                        <div class="col-md-4 form-group mb-3">
                            <label for="repair_category" class="font-weight-bold">Total DC LIMIT</label>
                    ...
                    <form method="post" action="{{ route('emirates_id_card.store')  }}"  enctype="multipart/form-data">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <label for="repair_category">Select Platform</label>
                                <h4 id="to_platform_name" class="font-weight-bold">N/A</h4>
                            </div>
            ...
            <div class="card text-left">
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="{{ route('dc_transfer_save') }}" method="POST">
                            @csrf
                            ...
                            <input type="hidden" value="" id="select_to_dc_id" name="select_to_dc_id" >
...
@section('js')
    ...
    <script>
        function ajax_table_load(){
            ...
            $.ajax({
                url: "{{ route('display_rider_list_by_user_platform') }}",
                method: 'POST',
    ...
    <script>
        ...
        $(document).on("change", "#platform_id", function (e) {
            ...
            $("#to_platform_name").html($( "#platform_id option:selected" ).text());
            ...
            if(selected_platform!==null){
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var limit = parseInt(array.total_rider_assigned);
                        var i;
                        $('#quantity').empty();

                        for (i = 1; i <= limit; i++) {
                            var newOption = new Option(i, i, true, true);
                            // var newOption_2 = new Option(i, i, true, true);
    ...
    <script>
        $(document).on("change", "#to_dc_id", function (e) {
            ...
            var selected_platform = $("#platform_id option:selected").val();
