...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">DC Manager Dashborad</li>
    </ol>
</nav>
        ...
        <div class="col-2">
            <div class="card card-icon  bg-secondary text-16  main-menu" id="documents-menu" data-child-menu-items="documents-menu-items">
                <a href="#" class="card-body text-center text-white m-0 p-0 pt-16">
                    ...
                    <h3 class="font-weight-bold mt-3 text-white">{{ $total_order_not_implement }}</h3>
                    <p class="p-0">Total Rider Not implement  Yesterday Order</p>
                </a>
            </div>
        </div>
    </div>
