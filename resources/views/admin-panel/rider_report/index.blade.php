...
@section('content')
    ...
    <form method="post" action="{{ route('passport_collect.store') }}">
        ...
        <div class="row m-4">
            ...
            <div class="col-md-5 form-group  mb-3 selected_passport " style="display: none">
                <label for="repair_category">Name</label><br>
                <h4 id="full_name"></h4>
            </div>

            <div class="col-md-3 form-group  mb-3  selected_passport " style="display: none">
    ...
    <div id="all-row" style="display: none;">
...
@section('js')
    ...
    <script src="{{ asset('js/custom_js/rider_report.js') }}"></script>
