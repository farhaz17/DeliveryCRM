<div class="row">
    <div class="col-md-12 form-group">
        ...
        <input class="form-control" type="date" name="date" id="date" value="{{isset($food->documents)?$food->documents:""}}" readonly>
    </div>
    <div class="col-md-8 form-group">
        <label for="remarks" class="d-block text-left">Uploaded Documents</label>
        @if(isset($food))
            @if($food->box_img!=null)
                @foreach (json_decode($food->box_img) as $attach)
