      ...
      <!-- BRANDING -->
        ...
        <tr>
          <td valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;">
            ...
            <p style="font-size: 15px; font-weight: 400; line-height: 160%; color: #333333; font-family: 'Roboto', Arial, sans-serif;">Your application for the position of <b>{{$obj->jobs_created->job_title}}</b> has been acknowleged. We will contact you soon for further process.</p>
            <p>Regards,</p>
            <p>Team Zone</p>
