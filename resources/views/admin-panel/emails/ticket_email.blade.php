    ...
    Update Query for : {{$ticket->ticket_id}}
    <br>
    @if($ticket->is_checked==1)
    Your query has closed. Please check in application.
    @endif
    @if($ticket->is_checked==2)
        Your query has started. Please check in application.
    @endif
    @if($ticket->is_checked==3)
        Your query has rejected. Please check in application.
    @endif
