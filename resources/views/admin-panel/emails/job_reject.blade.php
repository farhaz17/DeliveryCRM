      ...
      <!-- BRANDING -->
        <tr>
          <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-top: 20px;">
            {{-- <h1 style="color: #d1272e; font-family: 'Roboto', Arial, sans-serif; font-size: 18px; line-height: 120%; margin-bottom: 5px; text-transform: uppercase;">Builders Mutual</h1> --}}
          </td>
        </tr>
        <!-- MAIN TITLE -->
        <tr>
          <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;">
            {{-- <h1 style="color: #333; font-family: 'Roboto', Arial, sans-serif; font-size: 26px; font-weight: 800; margin: 0; text-transform: capitalize;">New Onboarding Request</h1> --}}
          </td>
        </tr>
        <!-- PRIMARY IMAGE -->
        <tr>
          <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-top: 20px;">
            {{-- <img border="0" vspace="0" hspace="0" src="assets/images/zonelogo.jpg" alt="Builders Mutual" title="Builders Mutual" width="500" style="border: none; color: #333333; display: block; font-size: 13px; margin: 0; max-width: 560px; padding: 0; outline: none; text-decoration: none; width: 100%; -ms-interpolation-mode: bicubic;"/> --}}
        <h1 style="color:darkred; align:center">Zone Delievery Services</h1>
        </td>
        </tr>
        <!-- CONTENT -->
        <tr>
          <td valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;">
            <p style="font-size: 15px; font-weight: 400; line-height: 160%; color: #333333; font-family: 'Roboto', Arial, sans-serif; margin: 30px 0 0 0;"></p>
            <p style="font-size: 15px; font-weight: 400; line-height: 160%; color: #333333; font-family: 'Roboto', Arial, sans-serif;">We received your application for the position of <b>{{$obj->jobs_created->job_title}}</b> . Unfortunatly this time we are not proceeeding with your application.</p>
            <p>Regards,</p>
            <p>Team Zone</p>
        ...
        <!-- LINE BREAK -->
        <tr>
          <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding-bottom: 10px; padding-left: 6.25%; padding-right: 6.25%; padding-top: 10px; width: 87.5%;" class="line">
      ...
      <table border="0" cellpadding="0" cellspacing="0" align="center" width="560" style="border-collapse: collapse; border-spacing: 0; padding: 0; width: inherit; max-width: 560px;" class="wrapper">
        <tr>
          <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; font-size: 12px; font-weight: 400; line-height: 150%; padding-top: 20px; padding-bottom: 20px; color: #999999; font-family: 'Roboto', Arial, sans-serif;" class="footer">
              Copyright © 2021 Builders Mutual. All Rights Reserved.
          </td>
        </tr>
      </table>
    </td>
