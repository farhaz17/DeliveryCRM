...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Talabat Rider Performances</li>
        </ol>
    </nav>
    ...
    <div class="row pb-2" >
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                               ...
                               <div class="col-md-2">
                                  <div class="card card-icon ticket-card">
                                     <div class="card-body text-center bg-success" style="display: grid;grid-template-columns: auto auto auto;align-items: center; padding:10px 0">
                                        ...
                                        <p class="text-white m-0" id="completed_orders">0</p>
                                        <p class="text-white mt-2 mb-2">Completed</p>
                                     </div>
                                  </div>
                               </div>
                               <div class="col-md-2">
                                  <div class="card card-icon ticket-card">
                                     <div class="card-body text-center bg-danger" style="display: grid;grid-template-columns: auto auto auto;align-items: center; padding:10px 0">
                                        <i class="text-white i-Gift-Box"></i>
                                        <p class="text-white m-0" id="cancelled_orders">0</p>
                                        <p class="text-white mt-2 mb-2">Cancelled</p>
                                     </div>
                                  </div>
                               </div>
                               <div class="col-md-2">
                                  <div class="card card-icon ticket-card">
                                     <div class="card-body text-center bg-info" style="display: grid;grid-template-columns: auto auto auto;align-items: center; padding:10px 0">
                                        ...
                                        <p class="text-white m-0" id="completed_deliveries">0</p>
                               ...
                               <div class="col-md-2">
                                  <div class="card card-icon ticket-card">
                                     <div class="card-body text-center bg-primary" style="display: grid;grid-template-columns: auto auto auto;align-items: center; padding:10px 0">
                                        <i class="text-white i-Ticket"></i>
                                        <p class="text-white m-0 " id="total_working_hours">0</p>
                                        <p class="text-white mt-2 mb-2">hrs worked</p>
                                     </div>
                                  </div>
                               </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group col-2 float-left">
                                <label for="result_type">Show Results</label>
                                <select name="result_type" id="result_type" class="form-control form-control-sm select2">
                                    <option value="single">in single row</option>
                                    <option value="multiple">in multiple rows</option>
                                </select>
                            </div>
                ...
                <div class="card-body" id="TalabatRiderPerformanceHolder"></div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            $('#show_performance_btn').on('click',function(){
                ...
                $.ajax({
                    url: "{{ route('talabat_rider_performances_view') }}",
                    data: { dc_id , start_date, end_date, result_type},
                    success: function(response){
                        $('#TalabatRiderPerformanceHolder').empty();
                        $('#TalabatRiderPerformanceHolder').append(response.html);
                        ...
                        $('#completed_orders').text(response.completed_orders)
                        $('#cancelled_orders').text(response.cancelled_orders)
                        $('#completed_deliveries').text(response.completed_deliveries)
                        $('#total_working_hours').text(response.total_working_hours)
