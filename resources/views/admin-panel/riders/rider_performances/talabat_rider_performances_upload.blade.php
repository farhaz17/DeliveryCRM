...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Talabat Performance Sheet Upload</li>
        </ol>
    </nav>
    ...
    <div class="row pb-2" >
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('talabat_rider_performances.store') }}"  aria-label="{{ __('Upload') }}" >
                        @csrf
                        ...
                        <div class="col-md-2 form-group"  style="float: left;" >
                            <a href="{{ asset('assets/sample/performances/talabat_performance_sample.xlsx') }}" class="float-right" target="_blank">( Download Sample File )</a>
                        </div>
