...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">DRC Module</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-2">
        ...
        <div class="row">
            <div class="col-2 mb-2">
                <div class="card card-icon bg-success">
                    <a href="{{ route('drc_rider_operations') }}" class="card-body text-center p-2 text-white">
            ...
            <div class="col-2 mb-2">
                <div class="card card-icon bg-success">
                    <a href="{{ route('dc_request.create') }}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Dashboard"></i>
                        <span class="item-name">Make Checkout Request</span>
                    </a>
                </div>
            </div>
