...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">DRCM Module</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-2">
        ...
        <div class="row">
            ...
            <div class="col-2 mb-2">
                <div class="card card-icon bg-success">
                    <a href="{{ route('drcm_rider_operations')}}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Dashboard"></i>
                        <span class="item-name">Manager Defaulter Riders</span>
                    </a>
                </div>
            </div>
            ...
            <div class="col-2 mb-2">
                <div class="card card-icon bg-success">
                    <a href="{{ route('checkin_request_for_defaulter_manager')}}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Dashboard"></i>
                        <span class="item-name">Defaulter Riders Checkin Request</span>
                    </a>
                </div>
            </div>
            ...
            <div class="col-2 mb-2">
                <div class="card card-icon bg-success">
                    <a href="{{ route('request_for_checkout_defaulter_manager')}}" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Dashboard"></i>
                        <span class="item-name">Defaulter Riders Checkout Request</span>
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-2 mb-2">
                <div class="card card-icon bg-primary">
                    <a href="#" class="card-body text-center p-2 text-white">
                        <i class="nav-icon i-Library header-icon"></i>
                        <span class="item-name">Defaulter Riders</span>
                    </a>
                </div>
            </div>
        </div>
