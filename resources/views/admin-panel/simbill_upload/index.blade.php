...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Financial"></i>
                                <div class="content">
                                    <p class="text-muted mt-2 mb-0">Total Amount To Pay</p>
                                    <p class="text-primary text-24 line-height-1 mb-2" id="total_amount">{{ $total_amount_to_pay }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Financial"></i>
                                <div class="content">
                                    <p class="text-muted mt-2 mb-0">Total Amount Due</p>
                                    <p class="text-primary text-24 line-height-1 mb-2" id="total_amount">{{ $total_amount_due }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Motorcycle"></i>
                                <div class="content">
                                    ...
                                    <p class="text-primary text-24 line-height-1 mb-2" id="total_rider">{{ $total_count }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-md-12 mb-3  ">
        <div class=" text-left">
            <div class="card text-left card_stick_main  ">
                <div class="card-body card_stick_body">
                    <div class="table-responsive">
                        <table class="display table table-striped table-bordered" id="datatable_not_employee">
                            ...
                            <tbody>
                            @foreach($sim_bills as $sim)
                                <tr>
                                    <td>{{ $sim->created_at->toDateString() }}</td>
                                    <td>{{ $sim->account_number }}</td>
                                    <td>{{ $sim->party_id }}</td>
                                    <td>{{ $sim->product_type }}</td>
                                    <td>{{ $sim->invoice_number }}</td>
                                    <td>{{ $sim->invoice_date }}</td>
                                    <td>{{ $sim->service_rental }}</td>
                                    <td>{{ $sim->usage_charge }}</td>
                                    <td>{{ $sim->one_time_charges }}</td>
                                    <td>{{ $sim->other_credit_and_charges }}</td>
                                    <td>{{ $sim->vat_on_taxable_services }}</td>
                                    <td>{{ $sim->billed_amoount }}</td>
                                    <td>{{ $sim->total_amount_due }}</td>
                                    <td>{{ $sim->amount_to_pay }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
        ...
        function verify_load_data(from_date= '', end_date= '',type='',platform=''){
            ...
            var table = $('#datatable_not_employee').DataTable({
                ...
                columns: [
                    ...
                    {data: 'toll_gate', name: 'ticket_date'},
        ...
        $(document).ready(function () {
            ...
            $("#apply_filter").click(function(){
                ...
                if(start_date != '' &&  end_date != '')
                {
                    ...
                    get_main_digits(start_date,normal_platform_id);
                }
                else
                {
