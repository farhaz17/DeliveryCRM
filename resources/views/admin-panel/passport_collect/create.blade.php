...
@section('content')
    ...
    <form method="post" action="{{ route('passport_collect.store') }}">
        {!! csrf_field() !!}
        ...
        <div class="row m-4">
            ...
            <div id="submitDate" class="col-md-4 form-group mb-3" style="display:none;">
                <label for=""repair_category">Submitting Date</label>
                <input class="form-control form-control" name="submit_date" type="date" placeholder="Submiting Date"  />
            </div>
            <div class="col-md-12">
...
<script src="{{ asset('js/custom_js/passport_handle.js') }}"></script>
