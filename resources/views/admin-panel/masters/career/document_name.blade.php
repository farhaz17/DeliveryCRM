...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">Document Name</div>
                    <form method="post" action="{{isset($doc)?route('career_document_name.update',$doc->id):route('career_document_name.store')}}">
                        @csrf
                        @if(isset($doc))
                            @method('Put')
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                <label for="repair_category">Document Name</label>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="display table table-striped table-bordered text-10 table-sm" id="datatable">
                        ...
                        <tbody>
                        @foreach($documents as $com)
                            <tr>
                                <th scope="row">1</th>
                                <td>{{$com->name}}</td>
                                <td>
                                    <a class="text-success mr-2" href="{{route('career_document_name.edit',$com->id)}}"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
