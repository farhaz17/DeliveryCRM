...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">Occupation Master</div>
                    <form method="post" action="{{isset($parts_data)?route('parts.update',$parts_data->id):route('parts.store')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input class="form-control form-control-rounded" id="company" name="company" type="text" placeholder="Enter Company Name" required />
                            </div>

                            <div class="col-md-6 form-group mb-3">
                                <label for="repair_category">State</label>
                                <input class="form-control form-control-rounded" id="state" name="state"  type="number" placeholder="Enter State" />
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label for="repair_category"> Issue Date</label>
                                <input class="form-control form-control-rounded" id="issue_date" name="issue_date"  type="number" placeholder="Enter Date if Issue" />
                            </div>
                            <div class="col-md-6 form-group mb-3">
