        ...
        <div class="col-md-4">
            <div class="card mb-4" style="background: #dedede">
                <div class="card-body">
                    ...
                    <form method="post" action="{{url('category_visa_store')}}">
                        {!! csrf_field() !!}
                        @if(isset($parts_data))
                            {{ method_field('PUT') }}
                        @endif
        ...
        <div class="col-md-4">
            <div class="card mb-4" style="background: skyblue;">
                <div class="card-body">
                    ...
                    <form method="post" action="{{url('sub_category_visa_store')}}">
                        {!! csrf_field() !!}
                        @if(isset($parts_data))
                            {{ method_field('PUT') }}
                        @endif
                            ...
                            <ul class="mb-1 pl-3 pb-2">
                                @foreach($main_category as $main)
                                    ...
                                    <li><i class="fas fa-angle-right rotate"></i>
                                        ...
                                        @if(isset($main->visa_subcategories))
                                            <ul class="nested">
                                                @foreach($main->visa_subcategories as $sub)
