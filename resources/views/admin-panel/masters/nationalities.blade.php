...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="card-title mb-3">Nationalities Details</div>
                    <form method="post" action="{{isset($nation_data)?route('nation_update',$nation_data->id):route('nation_store')}}">
                        {{ method_field('GET') }}
                        @if(isset($nation_data))
                            {{ method_field('GET') }}
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <input class="form-control form-control-rounded" id="name" name="name" value="{{isset($nation_data)?$nation_data->name:""}}" type="text" placeholder="Enter the Nationality name" />
                            </div>
                            <div class="col-md-12">
                    ...
                    <table class="display table table-striped table-bordered" id="datatable">
                        ...
                        @foreach($nation as $nat)
                            <tr>
                                ...
                                <td>{{$nat->name}}</td>
                                <td>
                                    <a class="text-success mr-2" href="{{route('nation_edit',$nat->id)}}"><i class="nav-icon i-Pen-2 font-weight-bold"></i></a>
