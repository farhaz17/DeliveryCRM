        ...
        <div class="col-md-4">
            <div class="card mb-4" style="background: #dedede">
                <div class="card-body">
                    ...
                    <form method="post" action="{{url('working_category_store')}}">
                        {!! csrf_field() !!}
                        @if(isset($parts_data))
                            {{ method_field('PUT') }}
                        @endif
        ...
        <div class="col-md-4">
            <div class="card mb-4" style="background: skyblue;">
                <div class="card-body">
                    ...
                    <form method="post" action="{{url('working_sub_category_store')}}">
                        {!! csrf_field() !!}
                        @if(isset($parts_data))
                            {{ method_field('PUT') }}
                        @endif
                            ...
                            <ul class="mb-1 pl-3 pb-2">
                                @foreach($main_category as $main)
                                    ...
                                    <li><i class="fas fa-angle-right rotate"></i>
                                        ...
                                        @if(isset($main->working_subcategories))
                                            <ul class="nested">
                                                @foreach($main->working_subcategories as $sub)
