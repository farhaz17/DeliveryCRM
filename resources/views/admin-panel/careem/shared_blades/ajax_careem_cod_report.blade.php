<div class="col-12">
    <div class="alert alert-card alert-info text-center mb-5" role="alert">
        <h4>{{request('date_range') == 'latest' ? "Current Careem COD" : "Careem COD Collection Report" }}</h4>
...
<div class="col-12">
    <ul class="nav nav-tabs small" id="myTab" role="tablist">
        <li class="nav-item">
            ...
            <a class="nav-link active" id="UploadedCareemCodTab" data-toggle="tab" href="#UploadedCareemCod" role="tab" aria-controls="UploadedCareemCod" aria-selected="true">All Uploaded COD ( AED. {{ number_format($uploaded_cods->sum('total_driver_other_cost') ?? 0, 2) }} )</a>
        </li>
        <li class="nav-item">
            {{-- adding new tabs please follow the tab id and table id with endingTable with the following naming convensions  --}}
            <a class="nav-link" id="CashCareemCodTab" data-toggle="tab" href="#CashCareemCod" role="tab" aria-controls="CashCareemCod" aria-selected="true">Cash Received ( AED. {{ number_format($cods->where('type', 0)->sum('amount') ?? 0, 2) }} )</a>
        </li>
        <li class="nav-item">
            {{-- adding new tabs please follow the tab id and table id with endingTable with the following naming convensions  --}}
            <a class="nav-link" id="BankCareemCodTab" data-toggle="tab" href="#BankCareemCod" role="tab" aria-controls="BankCareemCod" aria-selected="true">Bank Received ( AED. {{ number_format($cods->where('type', 1)->sum('amount') ?? 0, 2) }} )</a>
        </li>
        {{-- <li class="nav-item"> --}}
            {{-- adding new tabs please follow the tab id and table id with endingTable with the following naming convensions  --}}
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="UploadedCareemCod" role="tabpanel" aria-labelledby="UploadedCareemCodTab">
            <div class="table-responsive">
                <table class="table table-sm table-hover text-11" id="UploadedCareemCodTable">
                    <thead>
                        <tr>
                            {{-- <th>ID</th> --}}
                            <th>Rider Id</th>
        ...
        <div class="tab-pane fade" id="CashCareemCod" role="tabpanel" aria-labelledby="CashCareemCodTab">
            <div class="table-responsive">
                <table class="table table-sm table-hover text-11" id="CashCareemCodTable">
                    <thead>
                        <tr>
                            {{-- <th>ID</th> --}}
                            <th>RiderID</th>
        ...
        <div class="tab-pane fade" id="BankCareemCod" role="tabpanel" aria-labelledby="BankCareemCodTab">
            <div class="table-responsive">
                <table class="table table-sm table-hover text-11" id="BankCareemCodTable">
                    <thead>
                        <tr>
                            {{-- <th>ID</th> --}}
                            <th>Rider Id</th>
...
<script>
    $(document).ready(function () {
        'use-strict',
        $('#UploadedCareemCodTable, #CashCareemCodTable, #BankCareemCodTable, #AdjustmentCodTable').DataTable( {
