...
<div class="col-md-6 form-group mb-3">
    <label for="">Bike Number (Permanent)</label>
    <h6>{{ $result_bike }}</h6>
</div>

@if(isset($result_bike_temp))
<div class="col-md-6 form-group mb-3">
    <label for="">Bike Number (Temporary)</label>
    <h6>{{ $result_bike_temp }}</h6>
</div>
@endif
            ...
            <div class="col-md-12 form-group mb-3">
                <label for="checkout_date">Please select the Replace Type <b>(Required)</b></label>
                 <br>
               ...
               @if(isset($result_bike_temp))
                    <div class="form-check-inline">
                        <label class="radio radio-outline-success">
                            <input type="radio" name="repalce_bike_type"  id="repalce_bike_type" value="1"><span>Remove Only the Temporary Bike</span><span class="checkmark"></span>
                        </label>
                    </div>

                    <div class="form-check-inline">
                        <label class="radio radio-outline-success">
                            <input type="radio" name="repalce_bike_type" id="repalce_bike_type"  value="2"><span>Give him new Bike and checkout the Temporay and Permanent Bike</span><span class="checkmark"></span>
                        </label>
                    </div>
                ...
                <div class="form-check-inline">
                    <label class="radio radio-outline-success">
                        <input type="radio" name="repalce_bike_type"  id="repalce_bike_type" value="3"><span>Give him New Temporary Bike</span><span class="checkmark"></span>
                    </label>
                </div>
                ...
                <div class="form-check-inline">
                    <label class="radio radio-outline-success">
                        <input type="radio" name="repalce_bike_type" id="repalce_bike_type"  value="4"><span>Replace Current Bike With New Bike</span><span class="checkmark"></span>
                    </label>
                </div>
                @endif
            ...
            <div class="col-md-12 form-group mb-3" id="assign_bike_id" style="display: none;" >
                <label for="">Select the Bike Please</label><br>
                <select class="form-control" id="new_bike_id" name="new_bike_id">
    ...
    <script>
        $('#new_bike_id').select2({
            placeholder: 'Select a Bike',width: '100%'
        });
    </script>
